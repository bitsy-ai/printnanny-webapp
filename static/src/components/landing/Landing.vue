          ...
          >
            <div>
              ...
              <p class="mt-5 max-w-prose mx-auto text-xl text-gray-500">
                Get notified or pause if a print doesn't pass quality standards.
              </p>
            </div>
            <div class="mt-12">
...
const navigation = [
  { name: "Demo", href: "#demo" },
  { name: "Raspberry Pi", href: "#printnanny-os-for-raspberrypi" },
  { name: "Learn More", href: "#learn-more" },
  { name: "Become a Founding Member", href: "#founding-member" },
];
const features = [
  {
    name: "Push to Deploy",
