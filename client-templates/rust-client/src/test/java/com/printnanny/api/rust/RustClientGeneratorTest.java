 ...
 * 1) Set a break point in RustClientGenerator.java in the postProcessOperationsWithModels() method.
...
public class RustClientGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("rust-client") // use this codegen library
              ...
              .setOutputDir("out/rust-client"); // output directory
