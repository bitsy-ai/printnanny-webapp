...
public class RustClientGenerator extends DefaultCodegen implements CodegenConfig {
    ...
    for (Map.Entry<String, Object> entry : objs.entrySet()) {
      ...
      for (Map<String, Object> mo : models) {
        ...
        if (cm.discriminator != null) {
          ...
          // String vendorExtensionTagName =
          // cm.discriminator.getPropertyName().replace("_", "");
  ...
  public String toOperationId(String operationId) {
    ...
    if (isReservedWord(sanitizedOperationId)) {
      LOGGER.warn("{} (reserved word) cannot be used as method name. Renamed to {}", operationId,
          StringUtils.underscore("call_" + operationId));
  ...
  public Map<String, Object> postProcessOperationsWithModels(Map<String, Object> objs, List<Object> allModels) {
    ...
    for (CodegenOperation operation : operations) {
       ...
       * if ( operation.returnType.startsWith("Vec") &&
       * !languageSpecificPrimitives.contains(operation.returnBaseType)) {
       * // array of model
       * String rt = operation.returnType;
       * int end = rt.lastIndexOf(">");
       * if ( end > 0 ) {
       * operation.vendorExtensions.put("x-returnTypeInMethod", "Vec<super::" +
       * rt.substring("Vec<".length(), end).trim() + ">");
       * operation.returnContainer = "List";
       * }
       * } else if
       * (operation.returnType.startsWith("::std::collections::HashMap<String, ") &&
       * !languageSpecificPrimitives.contains(operation.returnBaseType)) {
       ...
       * int end = rt.lastIndexOf(">");
       * if ( end > 0 ) {
       * operation.vendorExtensions.put("x-returnTypeInMethod",
       * "::std::collections::HashMap<String, super::" +
       * rt.substring("::std::collections::HashMap<String, ".length(), end).trim() +
       * ">");
       * operation.returnContainer = "Map";
       * }
       * } else if (!languageSpecificPrimitives.contains(operation.returnType)) {
       * // add super:: to model, e.g. super::pet
       * operation.vendorExtensions.put("x-returnTypeInMethod", "super::" +
       ...
       * int end = rt.lastIndexOf(">");
       * if ( end > 0 ) {
       * p.dataType = "::std::collections::HashMap<String, super::" +
       * rt.substring("::std::collections::HashMap<String, ".length(), end).trim() +
       * ">";
       * }
