...
class ApexArea {
  ...
  initCharts() {
    ...
    var colors = ['#fa6767'];
    var dataColors = document.getElementById('basic-area')
    ...
    //
    // var colors = ["#7BD39A"];
    // var dataColors =  document.getElementById('area-chart-github')
    //   .getAttribute('data-colors');
    // if (dataColors) {
    //   colors = dataColors.split(",");
    // }
...
//
    ...
    var dataColors = document.getElementById('spline-area')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(',');
    }
    ...
    var colors = ['#6c757d'];
    var dataColors = document.getElementById('area-chart-datetime')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(',');
    }
...
//
    ...
    var dataColors = document.getElementById('area-chart-negative')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(',');
    }
...
//
    ...
    var colors = ['#FF7F00'];
    var dataColors = document.getElementById('area-chart-github2')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(',');
    }
    ...
    var dataColors = document.getElementById('stacked-area')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(',');
    }
...
//
    ...
    var dataColors = document.getElementById('area-timeSeries')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(',');
    }
...
//
    var colors = ['#6c757d'];
    var dataColors = document.getElementById('area-chart-nullvalues')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(',');
    }
