          ...
          >
            ...
            <div class="flex pl-4 sm:pl-6">
              ...
              <dd class="ml-2 text-gray-700">
                ...
                <span v-if="item.price.recurring"
                  >per {{ item.price.recurring.interval }}</span
                >
              </dd>
            </div>
          </dl>
          ...
          <dd class="mt-2 text-gray-700">
            <address class="not-italic">
              ...
              <span
                ...
                class="block"
                >{{
                  order?.stripe_checkout_session_data?.shipping?.address.line2
                }}</span
              >

              <span class="block"
                >{{
                  order?.stripe_checkout_session_data?.shipping?.address.city
                }},
                {{
                  order?.stripe_checkout_session_data?.shipping?.address.state
                }},
                {{
                  order?.stripe_checkout_session_data?.shipping?.address.country
                }}
                {{
                  order?.stripe_checkout_session_data?.shipping?.address
                    .postal_code
      ...
      >
        <div>
          ...
          <dd class="mt-2 text-gray-700">
            ...
            <p v-else-if="order.products[0].is_subscription">
              {{
                order.stripe_checkout_session_data.subscription
        ...
        <div>
          ...
          <dd class="mt-2 text-gray-700">
            <!-- payment intent (one-time purchase)-->
            <address
              v-if="order?.stripe_checkout_session_data?.payment_intent"
              class="not-italic"
            >
              <span class="block">{{
                order?.stripe_checkout_session_data?.payment_intent?.charges
              ...
              <span
                v-if="
                  order?.stripe_checkout_session_data?.payment_intent?.charges
                    .data[0]?.billing_details?.address.line2 !== undefined
                "
                class="block"
                >{{
                  order?.stripe_checkout_session_data?.payment_intent?.charges
                    .data[0]?.billing_details?.address.line2
                }}</span
              >
              ...
              <span class="block"
                >{{
                  order?.stripe_checkout_session_data?.payment_intent?.charges
                    .data[0]?.billing_details?.address.city
                }},
                {{
                  order?.stripe_checkout_session_data?.payment_intent?.charges
                    .data[0]?.billing_details?.address.state
                }},
                {{
                  order?.stripe_checkout_session_data?.payment_intent?.charges
                    .data[0]?.billing_details?.address.country
                }}
                {{
                  order?.stripe_checkout_session_data?.payment_intent?.charges
                    .data[0]?.billing_details?.address.postal_code
                }}</span
              >
            </address>
            ...
            <!-- recurring subscription -->
            <address
              v-if="order?.stripe_checkout_session_data?.subscription"
              class="not-italic"
            >
              <span class="block">{{
                order?.stripe_checkout_session_data?.subscription
              ...
              <span class="block">{{
                order?.stripe_checkout_session_data?.subscription
                  .default_payment_method.billing_details?.address.line1
              }}</span>
              <span
                v-if="
                  order?.stripe_checkout_session_data?.subscription
                    .default_payment_method.billing_details?.address.line2 !==
                  undefined
                "
                class="block"
                >{{
              ...
              <span class="block"
                >{{
                  order?.stripe_checkout_session_data?.subscription
                    .default_payment_method.billing_details?.address.city
                }},
                {{
                  order?.stripe_checkout_session_data?.subscription
                    .default_payment_method.billing_details?.address.state
                }},
                {{
                  order?.stripe_checkout_session_data?.subscription
                    .default_payment_method.billing_details?.address.country
                }}
                {{
                  order?.stripe_checkout_session_data?.subscription
                    .default_payment_method.billing_details?.address.postal_code
                }}</span
              >
            </address>
          </dd>
