              ...
              <span class="flex w-full justify-between items-center">
                <span class="flex min-w-0 items-center justify-between space-x-3">
                  ...
                  <span class="flex-1 flex flex-col min-w-0">
                    <span class="text-gray-900 text-sm font-medium truncate">👋 Welcome, {{ account.user.first_name || 'Maker' }}</span>
                    <span class="text-gray-500 text-sm truncate">{{ account.user.email }}</span>
                  </span>
                </span>
