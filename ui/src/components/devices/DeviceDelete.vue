...
<template>
  <div class="bg-white overflow-hidden shadow rounded-lg">
    <div class="px-4 py-5 sm:px-6">
      <h1 class="prose prose-2xl">Are you sure you want to delete {{ router.currentRoute.value.query.hostname }}?</h1>
          <p class="prose">This cannot be un-done! {{ router.currentRoute.value.query.hostname }} will be reset to factory defaults. </p>
