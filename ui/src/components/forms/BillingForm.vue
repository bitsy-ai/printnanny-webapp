...
<template>
  <form class="space-y-8 divide-y divide-gray-200" v-if="billingStore.billingFormReady">
    <div class="space-y-8 divide-y divide-gray-200">
      <div>
        <div>
          <h3 class="text-lg leading-6 font-medium text-gray-900">Billing</h3>
          <p v-if="billingStore.summary.subscription.is_valid" class="mt-1 text-sm text-gray-500">Details about your current PrintNanny subscription.</p>
          <p v-if="!billingStore.summary.subscription.is_valid" class="mt-1 text-sm text-red-500">Your billing info needs correction.</p>
