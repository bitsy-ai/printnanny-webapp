...
<template>
  <form class="space-y-8 divide-y divide-gray-200" v-if="alertStore.settingsFormReady">
    <div class="space-y-8 divide-y divide-gray-200">
      <div>
        <div>
          <h3 class="text-lg leading-6 font-medium text-gray-900">Notifcations</h3>
      ...
      <div class="pt-8">
        <div>
          <h3 class="text-lg leading-6 font-medium text-gray-900">Print Status & Quality Control</h3>
