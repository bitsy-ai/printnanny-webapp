<template>
  <main>
    ...
    <!-- past releases -->
    <div id="releases" class="relative bg-gray-200 p-6 lg:py-12">
      <div
        class="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl"
      >
        <h2
        ...
        <h2
          class="text-base font-semibold tracking-wider text-indigo-600 uppercase text-center my-2"
        >
          Development updates delivered to your inbox
        </h2>
    ...
    <!-- community -->
    <div id="community" class="relative bg-gray-50 p-6 lg:py-12">
      <div
    ...
    >
      <div class="lg:col-span-3 grid space-y-7">
        ...
        <h2
          class="text-center tracking-tight font-extrabold text-white text-4xl xl:text-6xl pt-8 text-gray-900"
        >
          Events & Meetups
        </h2>
        <h2
    ...
    <div id="blog" class="relative bg-gray-300 p-6 lg:py-12">
      <div
        class="mt-12 mx-auto max-w-md px-4 grid gap-8 sm:max-w-lg sm:px-6 lg:px-8 lg:grid-cols-3 lg:max-w-7xl"
      >
        <div class="lg:col-span-3 grid space-y-7">
...
const features = [
  ...
  },
  {
    name: "Powerful API",
    description:
      "Build your own automation with API clients available for Rust, Typescript, and Python.",
    icon: CogIcon,
  },
  {
...
const blogPosts = [
  ...
  {
    id: 1,
    title: "PrintNanny @ TensorFlow Everywhere North America",
