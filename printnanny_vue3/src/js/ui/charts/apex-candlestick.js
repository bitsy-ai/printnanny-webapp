...
class ApexCandlestick {
  ...
  initCharts() {
    ...
    var dataColors = document.getElementById('simple-candlestick')
...
//
    var colors = ["#0acf97", "#fa5c7c"];
    var dataColors = document.getElementById('combo-candlestick')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
    ...
    var dataColors = document.getElementById('combo-bar-candlestick')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
