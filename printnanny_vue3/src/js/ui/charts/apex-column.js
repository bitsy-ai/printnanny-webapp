...
class ApexColumn {
  ...
  initCharts() {
    ...
    var dataColors = document.getElementById('basic-column')
...
//
    var colors = ["#727cf5"];
    var dataColors = document.getElementById('datalabels-column')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
...
//
    ...
    var dataColors = document.getElementById('stacked-column')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
...
//
    ...
    var dataColors = document.getElementById('full-stacked-column')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
...
//
    var colors = ["#fa5c7c"];
    var dataColors = document.getElementById('rotate-labels-column')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
...
//
    var colors = ["#727cf5"];
    var dataColors = document.getElementById('negative-value-column')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
...
//
    ...
    var dataColors = document.getElementById('distributed-column')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
...
//
    ...
    var dataColors = document.getElementById('range-column')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
