...
class ApexLine {
  ...
  initCharts() {
    ...
    var colors = ["#ffbc00"];
    var dataColors =  document.getElementById('line-chart')
...
//
    ...
    var dataColors =  document.getElementById('line-chart-datalabel')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
...
//
    ...
    var colors = ["#fa5c7c"];
    var dataColors =  document.getElementById('line-chart-zoomable')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
...
//
    var colors = ["#39afd1"];
    var dataColors =  document.getElementById('line-chart-annotations')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
...
//
    var colors = ["#727cf5"];
    var dataColors =  document.getElementById('line-chart-syncing')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
...
//
    ...
    var colors = ["#6c757d"];
    var dataColors =  document.getElementById('line-chart-syncing2')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
...
//
    ...
    var dataColors =  document.getElementById('line-chart-missing')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
...
//
    ...
    var dataColors =  document.getElementById('line-chart-dashed')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
...
//
    ...
    var colors = ["#0acf97"];
    var dataColors =  document.getElementById('line-chart-stepline')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
...
//
    ...
    var colors = ["#39afd1"];
    var dataColors =  document.getElementById('line-chart-realtime')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
