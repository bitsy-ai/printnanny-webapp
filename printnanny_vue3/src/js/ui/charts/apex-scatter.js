...
class ApexScatter {
  ...
  initCharts() {
    ...
    var dataColors = document.getElementById('basic-scatter')
...
//
    ...
    var dataColors = document.getElementById('datetime-scatter')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
...
//
    ...
    var dataColors = document.getElementById('scatter-images')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
    var options = {
      ...
      fill: {
        ...
        opacity: 1,
        image: {
          src: ['/images/ico-messenger.png', '/images/ico-instagram.png'],
          width: 40,
          height: 40
        }
      },
