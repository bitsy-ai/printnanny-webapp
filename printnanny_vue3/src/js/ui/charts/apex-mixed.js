...
class ApexMixed {
  ...
  initCharts() {
    ...
    var dataColors = document.getElementById('line-column-mixed')
...
//
    ...
    var dataColors = document.getElementById('multiple-yaxis-mixed')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
...
//
    ...
    var dataColors = document.getElementById('line-area-mixed')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
...
//
    var colors = ["#727cf5", "#39afd1", "#fa5c7c"];
    var dataColors = document.getElementById('all-mixed')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
