...
class ApexBar {
  ...
  initCharts(){
    ...
    var colors = ["#39afd1"];
    var dataColors = document.getElementById('basic-bar')
...
//
    ...
    var dataColors = document.getElementById('grouped-bar')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
...
//
    ...
    var dataColors = document.getElementById('stacked-bar')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
...
//
    ...
    var dataColors = document.getElementById('full-stacked-bar')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
...
//
    ...
    var dataColors = document.getElementById('negative-bar')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
...
//
    ...
    var dataColors = document.getElementById('timeline-chart')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
...
//
    ...
    var dataColors = document.getElementById('pattern-bar')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
...
//
    ...
    var dataColors = document.getElementById('datalables-bar')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
