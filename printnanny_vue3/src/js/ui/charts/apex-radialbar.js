...
class ApexRadialbar {
  ...
  initCharts() {
    ...
    var colors = ["#39afd1"];
    var dataColors =  document.getElementById('basic-radialbar')
...
//
    ...
    var dataColors =  document.getElementById('multiple-radialbar')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
...
//
    ...
    var dataColors =  document.getElementById('circle-angle-radial')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
...
//
    var colors = ["#727cf5"];
    var dataColors =  document.getElementById('stroked-guage-radial')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
...
//
    ...
    var dataColors =  document.getElementById('gradient-chart')
      .getAttribute('data-colors');
    if (dataColors) {
      colors = dataColors.split(",");
    }
