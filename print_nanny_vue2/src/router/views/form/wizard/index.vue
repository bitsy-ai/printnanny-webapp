      ...
      <div class="col-xl-6">
        <div class="card">
          <div class="card-body">
            ...
            <form-wizard shape="tab" color="#727cf5">
              <tab-content icon="mdi mdi-account-circle">
                <div class="row">
                  <div class="col-12">
                    <div class="form-group row mb-3">
                      ...
                      <div class="col-md-9">
                        <input id="name" type="text" class="form-control" value="hyper" />
                      </div>
                    </div>
                    <div class="form-group row mb-3">
      ...
      <div class="col-xl-6">
        <div class="card">
          <div class="card-body">
            ...
            <form-wizard color="#727cf5" error-color="#ff5c75">
              <tab-content
              ...
              <tab-content icon="mdi mdi-face-profile" :before-change="() => validateStep('step2')">
