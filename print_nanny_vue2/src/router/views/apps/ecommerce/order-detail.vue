      ...
      <div class="col-lg-7 col-md-10 col-sm-11">
        <div class="horizontal-steps mt-4 mb-4 pb-5">
          <div class="horizontal-steps-content">
            <div class="step-item">
              <span v-b-tooltip.bottom title="20/08/2018 07:24 PM">Order Placed</span>
            </div>
            <div class="step-item current">
              <span v-b-tooltip.bottom title="21/08/2018 11:32 AM">Packed</span>
            </div>
            <div class="step-item">
              <span>Shipped</span>
            </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <ul class="list-unstyled mb-0">
              <li>
                <p class="mb-2">
                  <span class="font-weight-bold mr-2">Payment Type:</span> Credit Card
                </p>
                <p class="mb-2">
                  <span class="font-weight-bold mr-2">Provider:</span> Visa ending in 2851
                </p>
                <p class="mb-2">
                  <span class="font-weight-bold mr-2">Valid Date:</span> 02/2020
                </p>
                <p class="mb-0">
