      ...
      <div class="col-xl-6">
        <div class="card">
          <div class="card-body">
            ...
            <abbr title="attribute">attr</abbr> vitae elit libero, a pharetra augue.
          </div>
          <!-- end card-body -->
        </div>
        <!-- end card-->
      ...
      <div class="col-xl-6">
        <div class="card">
          <div class="card-body">
            ...
            <p class="text-black-50">Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
            <p
              class="text-white-50 bg-dark mb-0"
      ...
      <div class="col-xl-4">
        <div class="card">
          <div class="card-body">
            ...
            <p
              class="text-muted font-14"
            >A list of items in which the order does not explicitly matter.</p>
            <ul>
