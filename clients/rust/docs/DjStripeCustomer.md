...
**coupon_start** | Option<**String**> | If a coupon is present, the date at which it was applied. | [readonly]
**coupon_end** | Option<**String**> | If a coupon is present and has a limited duration, the date that the discount will end. | [readonly]
...
**tax_exempt** | Option<[**crate::models::StripeCustomerTaxExempt**](StripeCustomerTaxExempt.md)> | Describes the customer's tax exemption status. When set to reverse, invoice and receipt PDFs include the text \"Reverse charge\".  * `exempt` - Exempt * `none` - None * `reverse` - Reverse | [optional]
**date_purged** | Option<**String**> |  | [readonly]
