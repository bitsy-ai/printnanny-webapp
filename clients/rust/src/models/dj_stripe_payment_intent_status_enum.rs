...
pub enum DjStripePaymentIntentStatusEnum {
...
impl ToString for DjStripePaymentIntentStatusEnum {
...
impl Default for DjStripePaymentIntentStatusEnum {
    fn default() -> DjStripePaymentIntentStatusEnum {
        Self::Canceled
    }
}
