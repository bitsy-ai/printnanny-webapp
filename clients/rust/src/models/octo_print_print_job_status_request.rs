...
impl OctoPrintPrintJobStatusRequest {
    pub fn new(subject_pattern: crate::models::OctoPrintPrintJobStatusSubjectPatternEnum, payload: crate::models::OctoPrintPrintJobPayloadRequest, event_type: crate::models::OctoPrintPrintJobStatusEventTypeEnum, octoprint_server: i32, pi: i32) -> OctoPrintPrintJobStatusRequest {
