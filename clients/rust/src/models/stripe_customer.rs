...
impl StripeCustomer {
    pub fn new(djstripe_id: i32, djstripe_created: String, djstripe_updated: String, id: String, coupon_start: String, coupon_end: String, date_purged: String, djstripe_owner_account: Option<String>, subscriber: Option<i32>) -> StripeCustomer {
        StripeCustomer {
            djstripe_id,
            djstripe_created,
            djstripe_updated,
