...
pub mod patched_user_details_request;
pub use self::patched_user_details_request::PatchedUserDetailsRequest;
...
pub mod user_details_request;
pub use self::user_details_request::UserDetailsRequest;
