...
pub struct PatchedVideoRecordingRequest {
    #[serde(rename = "id", skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[serde(rename = "capture_done", skip_serializing_if = "Option::is_none")]
    pub capture_done: Option<bool>,
    #[serde(rename = "cloud_sync_done", skip_serializing_if = "Option::is_none")]
    pub cloud_sync_done: Option<bool>,
    #[serde(rename = "combine_done", skip_serializing_if = "Option::is_none")]
    pub combine_done: Option<bool>,
...
impl PatchedVideoRecordingRequest {
    pub fn new() -> PatchedVideoRecordingRequest {
