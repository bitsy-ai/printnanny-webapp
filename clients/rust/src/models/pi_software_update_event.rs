...
impl PiSoftwareUpdateEvent {
    pub fn new(id: i32, created_dt: String, source: crate::models::SourceEnum, subject: String, version: String, event_type: crate::models::PiSoftwareUpdateEventType, polymorphic_ctype: i32, pi: i32) -> PiSoftwareUpdateEvent {
