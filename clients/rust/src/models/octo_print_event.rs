...
impl OctoPrintEvent {
    pub fn new(id: i32, event_type: crate::models::OctoPrintEventEventTypeEnum, octoprint_environment: crate::models::OctoprintEnvironment, octoprint_printer_data: crate::models::OctoprintPrinterData, event_source: Option<crate::models::EventSourceEnum>, print_nanny_plugin_version: String, print_nanny_client_version: String, octoprint_version: String, polymorphic_ctype: i32, octoprint_device: i32, user: i32) -> OctoPrintEvent {
        OctoPrintEvent {
            id,
            ts: None,
            event_type,
