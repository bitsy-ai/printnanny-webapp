...
impl OctoPrintEvent {
    pub fn new(id: i32, model: crate::models::OctoPrintEventModel, created_dt: String, source: crate::models::EventSource, event_name: crate::models::OctoPrintEventName, polymorphic_ctype: i32, user: i32, octoprint_server: i32, pi: i32) -> OctoPrintEvent {
        OctoPrintEvent {
            id,
            model,
            created_dt,
