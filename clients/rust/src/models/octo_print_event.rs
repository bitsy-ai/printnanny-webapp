...
pub struct OctoPrintEvent {
    ...
    pub event_type: Option<Box<crate::models::OctoPrintEventEventTypeEnum>>,
...
impl OctoPrintEvent {
    pub fn new(octoprint_environment: crate::models::OctoprintEnvironment, octoprint_printer_data: crate::models::OctoprintPrinterData, print_nanny_plugin_version: String, print_nanny_client_version: String, octoprint_version: String, octoprint_device: i32) -> OctoPrintEvent {
        OctoPrintEvent {
            id: None,
            ts: None,
            event_source: None,
