...
impl OctoPrintEvent {
    pub fn new(id: i32, event_type: crate::models::OctoPrintEventEventTypeEnum, ts: String, event_source: crate::models::EventSourceEnum, print_nanny_plugin_version: String, print_nanny_client_version: String, octoprint_version: String, polymorphic_ctype: i32, octoprint_device: i32, user: i32) -> OctoPrintEvent {
        OctoPrintEvent {
            id,
            event_type,
            ts,
