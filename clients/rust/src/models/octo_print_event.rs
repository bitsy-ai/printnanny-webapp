...
impl OctoPrintEvent {
    pub fn new(event_type: crate::models::OctoPrintEventEventTypeEnum, print_nanny_plugin_version: String, print_nanny_client_version: String, octoprint_version: String, octoprint_device: i32) -> OctoPrintEvent {
        OctoPrintEvent {
            id: None,
            event_type,
            ts: None,
