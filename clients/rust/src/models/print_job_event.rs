...
pub struct PrintJobEvent {
    ...
    pub event_type: crate::models::EventTypeD9eEnum,
    #[serde(rename = "ts")]
    pub ts: String,
...
impl PrintJobEvent {
    pub fn new(id: i32, event_type: crate::models::EventTypeD9eEnum, ts: String, event_source: crate::models::EventSourceEnum, print_nanny_plugin_version: String, print_nanny_client_version: String, octoprint_version: String, polymorphic_ctype: i32, octoprint_device: i32, user: i32) -> PrintJobEvent {
        PrintJobEvent {
            id,
            event_type,
            ts,
