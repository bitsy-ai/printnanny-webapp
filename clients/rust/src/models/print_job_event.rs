...
impl PrintJobEvent {
    pub fn new(event_type: crate::models::EventTypeD9eEnum, print_nanny_plugin_version: String, print_nanny_client_version: String, octoprint_version: String, octoprint_device: i32) -> PrintJobEvent {
        PrintJobEvent {
            id: None,
            event_type,
            ts: None,
