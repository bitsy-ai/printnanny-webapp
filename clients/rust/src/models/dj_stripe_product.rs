...
pub struct DjStripeProduct {
    ...
    #[serde(rename = "type")]
    pub _type: Option<Box<crate::models::DjStripeProductTypeEnum>>,
...
impl DjStripeProduct {
    pub fn new(djstripe_id: i32, djstripe_created: String, djstripe_updated: String, id: String, name: String, _type: Option<crate::models::DjStripeProductTypeEnum>) -> DjStripeProduct {
        DjStripeProduct {
            djstripe_id,
            djstripe_created,
            djstripe_updated,
