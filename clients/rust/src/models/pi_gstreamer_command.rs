...
impl PiGstreamerCommand {
    pub fn new(id: i32, created_dt: String, source: crate::models::SourceEnum, subject: String, event_type: crate::models::PiGstreamerCommandType, polymorphic_ctype: i32, pi: i32) -> PiGstreamerCommand {
        PiGstreamerCommand {
            id,
            created_dt,
            source,
