...
pub struct StripeCharge {
    ...
    #[serde(rename = "status")]
    pub status: Option<Box<crate::models::StripeChargeStatusEnum>>,
...
impl StripeCharge {
    pub fn new(djstripe_id: i32, djstripe_created: String, djstripe_updated: String, id: String, amount: String, amount_refunded: String, currency: String, status: Option<crate::models::StripeChargeStatusEnum>) -> StripeCharge {
        StripeCharge {
            djstripe_id,
            djstripe_created,
            djstripe_updated,
