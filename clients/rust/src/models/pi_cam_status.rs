...
impl PiCamStatus {
    pub fn new(id: String, subject_pattern: crate::models::PiCamStatusSubjectPatternEnum, created_dt: String, event_type: crate::models::PiCamStatusType, pi: i32) -> PiCamStatus {
        PiCamStatus {
            id,
            subject_pattern,
            created_dt,
