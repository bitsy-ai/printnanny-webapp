...
pub enum OctoPrintPrintJobStatusEventTypeEnum {
...
impl ToString for OctoPrintPrintJobStatusEventTypeEnum {
...
impl Default for OctoPrintPrintJobStatusEventTypeEnum {
    fn default() -> OctoPrintPrintJobStatusEventTypeEnum {
        Self::PrintProgress
    }
}
