...
impl SystemInfoRequest {
    pub fn new(machine_id: String, revision: String, model: String, serial: String, cores: i32, ram: i64, uptime: i64, rootfs_size: i64, rootfs_used: i64, bootfs_size: i64, bootfs_used: i64, datafs_size: i64, datafs_used: i64, pi: i32) -> SystemInfoRequest {
        SystemInfoRequest {
            machine_id,
            revision,
            model,
