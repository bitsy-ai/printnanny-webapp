...
impl SystemInfoRequest {
    pub fn new(machine_id: String, revision: String, model: String, serial: String, cores: i32, ram: i64, os_version_id: String, os_build_id: String, os_variant_id: String, uptime: i32, rootfs_size: i32, rootfs_used: i32, bootfs_size: i32, bootfs_used: i32, datafs_size: i32, datafs_used: i32, pi: i32) -> SystemInfoRequest {
        SystemInfoRequest {
            machine_id,
            revision,
            model,
