...
impl PiSoftwareUpdateCommand {
    pub fn new(id: String, subject_pattern: crate::models::PiSoftwareUpdateCommandSubjectPatternEnum, created_dt: String, version: String, event_type: crate::models::PiSoftwareUpdateCommandType, pi: i32) -> PiSoftwareUpdateCommand {
