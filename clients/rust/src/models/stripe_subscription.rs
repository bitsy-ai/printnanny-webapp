...
pub struct StripeSubscription {
    ...
    pub collection_method: Option<Box<crate::models::StripeInvoiceCollectionMethod>>,
    ...
    #[serde(rename = "status")]
    pub status: Option<Box<crate::models::StripeSubscriptionStatus>>,
...
impl StripeSubscription {
    pub fn new(djstripe_id: i32, plan: crate::models::StripePlan, default_payment_method: crate::models::StripePaymentMethod, schedule: crate::models::StripeSubscriptionSchedule, is_period_current: bool, is_status_current: bool, is_status_temporarily_current: bool, is_valid: bool, djstripe_created: String, djstripe_updated: String, id: String, collection_method: Option<crate::models::StripeInvoiceCollectionMethod>, current_period_end: String, current_period_start: String, status: Option<crate::models::StripeSubscriptionStatus>, customer: String) -> StripeSubscription {
        StripeSubscription {
            djstripe_id,
            plan: Box::new(plan),
