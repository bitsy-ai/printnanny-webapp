...
impl StripeSubscription {
    pub fn new(djstripe_id: i32, plan: crate::models::StripePlan, default_payment_method: crate::models::StripePaymentMethod, schedule: crate::models::StripeSubscriptionSchedule, djstripe_created: String, djstripe_updated: String, id: String, collection_method: Option<crate::models::CollectionMethodEnum>, current_period_end: String, current_period_start: String, status: Option<crate::models::StripeSubscriptionStatusEnum>, customer: String) -> StripeSubscription {
        StripeSubscription {
            djstripe_id,
            plan: Box::new(plan),
