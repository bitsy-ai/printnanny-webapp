...
impl JanusStream {
    pub fn new(id: i32, auth: Option<crate::models::JanusAuth>, api_domain: String, api_port: i32, api_url: String, admin_url: String, admin_port: i32, rtp_domain: String, websocket_url: String, websocket_port: i32, created_dt: String, updated_dt: String, rtp_port: i32, device: i32) -> JanusStream {
        JanusStream {
            id,
