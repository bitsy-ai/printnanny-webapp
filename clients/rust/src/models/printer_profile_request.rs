...
impl PrinterProfileRequest {
    pub fn new(octoprint_device: i32, name: String, octoprint_key: String) -> PrinterProfileRequest {
        PrinterProfileRequest {
            octoprint_device,
            axes_e_inverted: NoneSome(,
            axes_e_speed: NoneSome(,
            axes_x_speed: NoneSome(,
            axes_x_inverted: NoneSome(,
            axes_y_inverted: NoneSome(,
            axes_y_speed: NoneSome(,
            axes_z_inverted: NoneSome(,
            axes_z_speed: NoneSome(,
            extruder_count: NoneSome(,
            extruder_nozzle_diameter: NoneSome(,
            extruder_shared_nozzle: NoneSome(,
            heated_bed: NoneSome(,
            heated_chamber: NoneSome(,
            model: NoneSome(,
            name,
            octoprint_key,
            volume_custom_box: None,
            volume_depth: NoneSome(,
            volume_formfactor: NoneSome(,
            volume_height: NoneSome(,
            volume_origin: NoneSome(,
            volume_width: NoneSome(,
        }
    }
}
