...
pub struct StripePaymentMethod {
    ...
    #[serde(rename = "type")]
    pub _type: Option<Box<crate::models::StripePaymentMethodType>>,
...
impl StripePaymentMethod {
    pub fn new(djstripe_id: i32, djstripe_created: String, djstripe_updated: String, id: String, billing_details: ::std::collections::HashMap<String, serde_json::Value>, _type: Option<crate::models::StripePaymentMethodType>) -> StripePaymentMethod {
        StripePaymentMethod {
            djstripe_id,
            djstripe_created,
            djstripe_updated,
