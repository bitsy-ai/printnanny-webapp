...
pub struct DjStripePaymentIntent {
    ...
    pub cancellation_reason: Option<Box<crate::models::OneOfCancellationReasonEnumBlankEnum>>,
    /// Capture method of this PaymentIntent, one of automatic or manual.
    #[serde(rename = "capture_method")]
    pub capture_method: Option<Box<crate::models::CaptureMethodEnum>>,
    ...
    pub confirmation_method: Option<Box<crate::models::ConfirmationMethodEnum>>,
    ...
    #[serde(rename = "setup_future_usage", skip_serializing_if = "Option::is_none")]
    pub setup_future_usage: Option<Box<crate::models::OneOfSetupFutureUsageEnumBlankEnumNullEnum>>,
    ...
    #[serde(rename = "status")]
    pub status: Option<Box<crate::models::DjStripePaymentIntentStatusEnum>>,
...
impl DjStripePaymentIntent {
    pub fn new(djstripe_id: i32, charges: Vec<crate::models::DjStripeCharge>, djstripe_created: String, djstripe_updated: String, id: String, amount: i64, amount_capturable: i64, amount_received: i64, capture_method: Option<crate::models::CaptureMethodEnum>, client_secret: String, confirmation_method: Option<crate::models::ConfirmationMethodEnum>, currency: String, payment_method_types: ::std::collections::HashMap<String, serde_json::Value>, status: Option<crate::models::DjStripePaymentIntentStatusEnum>) -> DjStripePaymentIntent {
        DjStripePaymentIntent {
            djstripe_id,
            charges,
            djstripe_created,
