...
impl PrinterEvent {
    pub fn new(id: i32, event_type: crate::models::EventType0c4Enum, octoprint_environment: crate::models::OctoprintEnvironment, octoprint_printer_data: crate::models::OctoprintPrinterData, event_source: Option<crate::models::EventSourceEnum>, print_nanny_plugin_version: String, print_nanny_client_version: String, octoprint_version: String, printer_state: crate::models::PrinterStateEnum, polymorphic_ctype: i32, octoprint_device: i32, user: i32) -> PrinterEvent {
        PrinterEvent {
            id,
            ts: None,
            event_type,
