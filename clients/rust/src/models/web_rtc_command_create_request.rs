...
impl WebRtcCommandCreateRequest {
    pub fn new(model: crate::models::WebRtcCommandModel, source: crate::models::EventSource, event_name: crate::models::WebRtcCommandName, pi: i32, stream: i32) -> WebRtcCommandCreateRequest {
