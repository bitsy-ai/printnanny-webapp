...
pub enum StripePaymentMethodTypeEnum {
...
impl ToString for StripePaymentMethodTypeEnum {
...
impl Default for StripePaymentMethodTypeEnum {
    fn default() -> StripePaymentMethodTypeEnum {
        Self::AcssDebit
    }
}
