...
pub struct Device {
    ...
    pub janus_edge: Option<Box<crate::models::WebrtcStream>>,
    #[serde(rename = "janus_cloud")]
    pub janus_cloud: Option<Box<crate::models::WebrtcStream>>,
