...
impl VideoRecordingPart {
    pub fn new(id: String, mp4_upload_url: String, size: i64, buffer_index: i64, buffer_runningtime: i64, file_name: String, mp4_file: Option<String>, video_recording: String) -> VideoRecordingPart {
        VideoRecordingPart {
            id,
            mp4_upload_url,
            size,
