...
impl OctoPrintClientStatusRequest {
    pub fn new(payload: crate::models::OctoPrintClientStatusPayloadRequest, event_type: crate::models::OctoPrintClientStatusType, octoprint_server: i32, pi: i32) -> OctoPrintClientStatusRequest {
