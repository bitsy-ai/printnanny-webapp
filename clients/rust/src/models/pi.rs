...
impl Pi {
    pub fn new(id: i32, last_boot: String, settings: Option<crate::models::PiSettings>, cloudiot_device: Option<crate::models::CloudiotDevice>, user: Option<crate::models::User>, system_info: Option<crate::models::SystemInfo>, public_key: Option<crate::models::PublicKey>, webrtc_edge: Option<crate::models::WebrtcStream>, webrtc_cloud: Option<crate::models::WebrtcStream>, octoprint_server: Option<crate::models::OctoPrintServer>, urls: crate::models::PiUrls, created_dt: String) -> Pi {
        Pi {
            id,
            last_boot,
