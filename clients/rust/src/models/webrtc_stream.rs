...
impl WebrtcStream {
    pub fn new(created_dt: String, updated_dt: String, config_type: Option<crate::models::JanusConfigType>, device: i32, admin_secret: String, rtp_domain: String, pt: i32, rtpmap: String, admin_port: i32, admin_url: String, api_port: i32, api_url: String, api_domain: String, ws_port: i32, ws_url: String) -> WebrtcStream {
        WebrtcStream {
            created_dt,
            updated_dt,
