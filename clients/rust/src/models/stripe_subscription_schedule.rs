...
pub struct StripeSubscriptionSchedule {
    ...
    pub end_behavior: Option<Box<crate::models::StripeSubscriptionScheduleEndBehavior>>,
    ...
    #[serde(rename = "status")]
    pub status: Option<Box<crate::models::StripeSubscriptionScheduleStatus>>,
...
impl StripeSubscriptionSchedule {
    pub fn new(djstripe_id: i32, djstripe_created: String, djstripe_updated: String, id: String, end_behavior: Option<crate::models::StripeSubscriptionScheduleEndBehavior>, status: Option<crate::models::StripeSubscriptionScheduleStatus>, customer: i32) -> StripeSubscriptionSchedule {
