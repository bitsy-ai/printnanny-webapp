...
impl OctoPrintPrintJobStatus {
    pub fn new(id: String, subject_pattern: crate::models::OctoPrintPrintJobStatusSubjectPatternEnum, payload: crate::models::OctoPrintPrintJobPayload, created_dt: String, event_type: crate::models::OctoPrintPrintJobStatusEventTypeEnum, octoprint_server: i32, pi: i32) -> OctoPrintPrintJobStatus {
