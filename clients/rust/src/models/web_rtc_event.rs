...
impl WebRtcEvent {
    pub fn new(id: i32, model: crate::models::WebRtcEventModel, created_dt: String, source: crate::models::EventSource, event_name: crate::models::WebRtcEventName, polymorphic_ctype: i32, user: i32, pi: i32, stream: i32) -> WebRtcEvent {
        WebRtcEvent {
            id,
            model,
            created_dt,
