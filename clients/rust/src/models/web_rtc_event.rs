...
impl WebRtcEvent {
    pub fn new(id: i32, deleted: String, created_dt: String, source: crate::models::EventSource, event_type: crate::models::WebRtcEventType, polymorphic_ctype: i32, user: i32, device: i32) -> WebRtcEvent {
        WebRtcEvent {
            id,
            deleted,
            created_dt,
