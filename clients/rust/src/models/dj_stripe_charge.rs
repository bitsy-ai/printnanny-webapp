...
pub struct DjStripeCharge {
    ...
    pub failure_code: Option<Box<crate::models::OneOfFailureCodeEnumBlankEnum>>,
    ...
    #[serde(rename = "status")]
    pub status: Option<Box<crate::models::DjStripeChargeStatusEnum>>,
...
impl DjStripeCharge {
    pub fn new(djstripe_id: i32, djstripe_created: String, djstripe_updated: String, id: String, amount: String, amount_refunded: String, currency: String, status: Option<crate::models::DjStripeChargeStatusEnum>) -> DjStripeCharge {
        DjStripeCharge {
            djstripe_id,
            djstripe_created,
            djstripe_updated,
