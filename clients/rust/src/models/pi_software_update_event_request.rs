...
impl PiSoftwareUpdateEventRequest {
    pub fn new(source: crate::models::SourceEnum, subject: String, version: String, event_type: crate::models::PiSoftwareUpdateEventType, pi: i32) -> PiSoftwareUpdateEventRequest {
