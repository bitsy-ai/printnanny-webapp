...
impl PrintNannyPluginEvent {
    pub fn new(id: i32, event_type: crate::models::PrintNannyPluginEventEventTypeEnum, octoprint_environment: crate::models::OctoprintEnvironment, octoprint_printer_data: crate::models::OctoprintPrinterData, print_nanny_plugin_version: String, print_nanny_client_version: String, octoprint_version: String, polymorphic_ctype: i32, octoprint_device: i32, user: i32) -> PrintNannyPluginEvent {
