...
impl PrintNannyPluginEventRequest {
    pub fn new(event_type: crate::models::PrintNannyPluginEventEventTypeEnum, print_nanny_plugin_version: String, print_nanny_client_version: String, octoprint_version: String, octoprint_device: i32) -> PrintNannyPluginEventRequest {
