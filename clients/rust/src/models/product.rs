...
impl Product {
    pub fn new(djstripe_product: crate::models::DjStripeProduct, prices: Vec<crate::models::DjStripePrice>, deleted: Option<String>, deleted_by_cascade: bool, created_dt: String, updated_dt: String, sku: String, slug: String, unit_label: String, name: String, description: String, statement_descriptor: String, is_shippable: bool, is_preorder: bool, is_subscription: bool) -> Product {
        Product {
            id: None,
