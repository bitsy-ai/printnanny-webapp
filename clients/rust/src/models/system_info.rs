...
impl SystemInfo {
    pub fn new(id: i32, bootfs_available: i32, bootfs_available_pretty: String, bootfs_used_pretty: String, bootfs_size_pretty: String, datafs_available: i32, datafs_available_pretty: String, datafs_used_pretty: String, datafs_size_pretty: String, rootfs_available: i32, rootfs_available_pretty: String, rootfs_size_pretty: String, rootfs_used_pretty: String, created_dt: String, updated_dt: String, machine_id: String, revision: String, model: String, serial: String, cores: i32, ram: i64, os_version_id: String, os_build_id: String, os_variant_id: String, uptime: i32, rootfs_size: i32, rootfs_used: i32, bootfs_size: i32, bootfs_used: i32, datafs_size: i32, datafs_used: i32, pi: i32) -> SystemInfo {
        SystemInfo {
            id,
            bootfs_available,
