...
impl NatsApp {
    pub fn new(id: i32, name: String, json: ::std::collections::HashMap<String, serde_json::Value>, pi: i32, organization: i32, organization_user: i32, nats_uri: String) -> NatsApp {
        NatsApp {
            id,
            name,
            json,
