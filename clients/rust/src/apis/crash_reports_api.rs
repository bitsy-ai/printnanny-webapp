...
pub async fn video_recordings_create(configuration: &configuration::Configuration, recording_start: Option<String>, recording_end: Option<String>, recording_status: Option<crate::models::RecordingStatusEnum>, cloud_sync_start: Option<String>, cloud_sync_end: Option<String>, cloud_sync_status: Option<crate::models::CloudSyncStatusEnum>, gcode_file_name: Option<&str>, mp4_file: Option<std::path::PathBuf>) -> Result<crate::models::VideoRecording, Error<VideoRecordingsCreateError>> {
    let local_var_configuration = configuration;
...
pub async fn video_recordings_partial_update(configuration: &configuration::Configuration, id: &str, recording_start: Option<String>, recording_end: Option<String>, recording_status: Option<crate::models::RecordingStatusEnum>, cloud_sync_start: Option<String>, cloud_sync_end: Option<String>, cloud_sync_status: Option<crate::models::CloudSyncStatusEnum>, gcode_file_name: Option<&str>, mp4_file: Option<std::path::PathBuf>) -> Result<crate::models::VideoRecording, Error<VideoRecordingsPartialUpdateError>> {
    let local_var_configuration = configuration;
...
pub async fn video_recordings_update(configuration: &configuration::Configuration, id: &str, recording_start: Option<String>, recording_end: Option<String>, recording_status: Option<crate::models::RecordingStatusEnum>, cloud_sync_start: Option<String>, cloud_sync_end: Option<String>, cloud_sync_status: Option<crate::models::CloudSyncStatusEnum>, gcode_file_name: Option<&str>, mp4_file: Option<std::path::PathBuf>) -> Result<crate::models::VideoRecording, Error<VideoRecordingsUpdateError>> {
    let local_var_configuration = configuration;
