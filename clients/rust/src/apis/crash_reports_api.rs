...
pub async fn crash_reports_create(configuration: &configuration::Configuration, description: Option<&str>, email: Option<&str>, os_version: Option<&str>, os_logs: Option<std::path::PathBuf>, browser_version: Option<&str>, browser_logs: Option<std::path::PathBuf>, serial: Option<&str>, posthog_session: Option<&str>, status: Option<crate::models::CrashReportStatusEnum>, support_comment: Option<&str>, user: Option<i32>, pi: Option<i32>) -> Result<crate::models::CrashReport, Error<CrashReportsCreateError>> {
    ...
    if let Some(local_var_param_value) = os_version {
        local_var_form_params.insert("os_version", local_var_param_value.to_string());
    }
    if let Some(local_var_param_value) = os_logs {
        local_var_form_params.insert("os_logs", unimplemented!("File form param not supported with x-www-form-urlencoded content"));
    }
    if let Some(local_var_param_value) = browser_version {
        local_var_form_params.insert("browser_version", local_var_param_value.to_string());
    }
    if let Some(local_var_param_value) = browser_logs {
        local_var_form_params.insert("browser_logs", unimplemented!("File form param not supported with x-www-form-urlencoded content"));
    }
    if let Some(local_var_param_value) = serial {
        local_var_form_params.insert("serial", local_var_param_value.to_string());
    }
    if let Some(local_var_param_value) = posthog_session {
        local_var_form_params.insert("posthog_session", local_var_param_value.to_string());
    }
    ...
    if let Some(local_var_param_value) = support_comment {
        local_var_form_params.insert("support_comment", local_var_param_value.to_string());
    }
    ...
    if let Some(local_var_param_value) = pi {
        local_var_form_params.insert("pi", local_var_param_value.to_string());
    }
