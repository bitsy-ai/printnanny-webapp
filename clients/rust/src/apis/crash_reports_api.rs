...
pub async fn crash_reports_create(configuration: &configuration::Configuration, email: Option<&str>, os_version: Option<&str>, os_logs: Option<std::path::PathBuf>, browser_version: Option<&str>, browser_logs: Option<std::path::PathBuf>, serial: Option<&str>, user: Option<i32>, pi: Option<i32>) -> Result<crate::models::CrashReport, Error<CrashReportsCreateError>> {
    ...
    // TODO: support file upload for 'os_logs' parameter
    ...
    // TODO: support file upload for 'browser_logs' parameter
