...
pub async fn crash_reports_create(configuration: &configuration::Configuration, description: Option<&str>, email: Option<&str>, os_version: Option<&str>, os_logs: Option<std::path::PathBuf>, browser_version: Option<&str>, browser_logs: Option<std::path::PathBuf>, serial: Option<&str>, posthog_session: Option<&str>, status: Option<crate::models::CrashReportStatusEnum>, support_comment: Option<&str>, user: Option<i32>, pi: Option<i32>) -> Result<crate::models::CrashReport, Error<CrashReportsCreateError>> {
...
pub async fn crash_reports_partial_update(configuration: &configuration::Configuration, id: &str, description: Option<&str>, email: Option<&str>, os_version: Option<&str>, os_logs: Option<std::path::PathBuf>, browser_version: Option<&str>, browser_logs: Option<std::path::PathBuf>, serial: Option<&str>, posthog_session: Option<&str>, status: Option<crate::models::CrashReportStatusEnum>, support_comment: Option<&str>, user: Option<i32>, pi: Option<i32>) -> Result<crate::models::CrashReport, Error<CrashReportsPartialUpdateError>> {
    let local_var_configuration = configuration;
...
pub async fn crash_reports_update(configuration: &configuration::Configuration, id: &str, description: Option<&str>, email: Option<&str>, os_version: Option<&str>, os_logs: Option<std::path::PathBuf>, browser_version: Option<&str>, browser_logs: Option<std::path::PathBuf>, serial: Option<&str>, posthog_session: Option<&str>, status: Option<crate::models::CrashReportStatusEnum>, support_comment: Option<&str>, user: Option<i32>, pi: Option<i32>) -> Result<crate::models::CrashReport, Error<CrashReportsUpdateError>> {
    let local_var_configuration = configuration;
...
pub async fn videos_create(configuration: &configuration::Configuration, start_dt: String, name: &str, user: i32, end_dt: Option<String>, mjr_recording: Option<std::path::PathBuf>) -> Result<crate::models::VideoRecording, Error<VideosCreateError>> {
    let local_var_configuration = configuration;
    ...
    local_var_form = local_var_form.text("user", user.to_string());
    local_var_req_builder = local_var_req_builder.multipart(local_var_form);
...
pub async fn videos_partial_update(configuration: &configuration::Configuration, id: i32, start_dt: Option<String>, end_dt: Option<String>, name: Option<&str>, mjr_recording: Option<std::path::PathBuf>, user: Option<i32>) -> Result<crate::models::VideoRecording, Error<VideosPartialUpdateError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/videos/{id}/", local_var_configuration.base_path, id=id);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PATCH, local_var_uri_str.as_str());
...
pub async fn videos_update(configuration: &configuration::Configuration, id: i32, start_dt: String, name: &str, user: i32, end_dt: Option<String>, mjr_recording: Option<std::path::PathBuf>) -> Result<crate::models::VideoRecording, Error<VideosUpdateError>> {
    let local_var_configuration = configuration;
