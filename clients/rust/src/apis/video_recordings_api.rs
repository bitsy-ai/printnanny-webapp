...
pub async fn video_recordings_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<crate::models::VideoRecording, Error<VideoRecordingsRetrieveError>> {
