...
pub async fn accounts2fa_auth_email_create(configuration: &configuration::Configuration, email_auth_request: crate::models::EmailAuthRequest) -> Result<crate::models::DetailResponse, Error<Accounts2faAuthEmailCreateError>> {
...
pub async fn accounts2fa_auth_token_create(configuration: &configuration::Configuration, callback_token_auth_request: crate::models::CallbackTokenAuthRequest) -> Result<crate::models::TokenResponse, Error<Accounts2faAuthTokenCreateError>> {
    let local_var_configuration = configuration;
