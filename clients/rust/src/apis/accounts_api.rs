...
pub async fn accounts_auth_user_partial_update(configuration: &configuration::Configuration, patched_user_details_request: Option<crate::models::PatchedUserDetailsRequest>) -> Result<crate::models::UserDetails, Error<AccountsAuthUserPartialUpdateError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&patched_user_details_request);
...
/// Reads and updates UserModel fields Accepts GET, PUT, PATCH methods.  Default accepted fields: username, first_name, last_name Default display fields: pk, username, email, first_name, last_name Read-only fields: pk, email  Returns UserModel fields.
pub async fn accounts_auth_user_retrieve(configuration: &configuration::Configuration, ) -> Result<crate::models::UserDetails, Error<AccountsAuthUserRetrieveError>> {
    let local_var_configuration = configuration;
...
/// Reads and updates UserModel fields Accepts GET, PUT, PATCH methods.  Default accepted fields: username, first_name, last_name Default display fields: pk, username, email, first_name, last_name Read-only fields: pk, email  Returns UserModel fields.
pub async fn accounts_auth_user_update(configuration: &configuration::Configuration, user_details_request: Option<crate::models::UserDetailsRequest>) -> Result<crate::models::UserDetails, Error<AccountsAuthUserUpdateError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&user_details_request);
