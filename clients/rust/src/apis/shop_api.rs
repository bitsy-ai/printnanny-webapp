...
pub async fn shop_orders_create(configuration: &configuration::Configuration, order_checkout_request_request: crate::models::OrderCheckoutRequestRequest) -> Result<crate::models::Order, Error<ShopOrdersCreateError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&order_checkout_request_request);
