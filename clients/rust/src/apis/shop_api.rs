...
pub async fn shop_orders_create(configuration: &configuration::Configuration, order_checkout_request: crate::models::OrderCheckoutRequest) -> Result<crate::models::OrderCheckout, Error<ShopOrdersCreateError>> {
    let local_var_configuration = configuration;
