...
pub async fn video_recordings_finalize(configuration: &configuration::Configuration, id: &str, video_recording_request: Option<crate::models::VideoRecordingRequest>) -> Result<crate::models::VideoRecording, Error<VideoRecordingsFinalizeError>> {
    let local_var_configuration = configuration;
