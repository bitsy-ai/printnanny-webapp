...
pub async fn video_parts_create(configuration: &configuration::Configuration, id: &str, size: i64, buffer_index: i64, buffer_runningtime: i64, file_name: &str, video_recording: &str, mp4_file: Option<std::path::PathBuf>, sync_start: Option<String>) -> Result<crate::models::VideoRecordingPart, Error<VideoPartsCreateError>> {
    ...
    if let Some(local_var_param_value) = sync_start {
        local_var_form = local_var_form.text("sync_start", local_var_param_value.to_string());
    }
