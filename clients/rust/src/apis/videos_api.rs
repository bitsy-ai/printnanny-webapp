...
pub async fn pis_camera_snapshots_create(configuration: &configuration::Configuration, pi_id: i32, image: std::path::PathBuf, pi: i32, id: Option<&str>) -> Result<crate::models::CameraSnapshot, Error<PisCameraSnapshotsCreateError>> {
