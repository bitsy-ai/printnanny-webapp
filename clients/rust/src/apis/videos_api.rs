...
/// struct for typed errors of method [`video_recordings_update_or_create2`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum VideoRecordingsUpdateOrCreate2Error {
    Status409(crate::models::ErrorDetail),
    Status400(crate::models::ErrorDetail),
    Status401(crate::models::ErrorDetail),
    Status403(crate::models::ErrorDetail),
...
pub async fn video_recordings_update_or_create(configuration: &configuration::Configuration, id: &str, video_recording_part_request: crate::models::VideoRecordingPartRequest) -> Result<crate::models::VideoRecording, Error<VideoRecordingsUpdateOrCreateError>> {
    let local_var_configuration = configuration;
...
pub async fn video_recordings_update_or_create2(configuration: &configuration::Configuration, id: &str, video_recording_request: Option<crate::models::VideoRecordingRequest>) -> Result<crate::models::VideoRecording, Error<VideoRecordingsUpdateOrCreate2Error>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<VideoRecordingsUpdateOrCreate2Error> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
