...
/// struct for typed errors of method [`janus_stream_key_update_or_create`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum JanusStreamKeyUpdateOrCreateError {
    Status409(crate::models::ErrorDetail),
    Status400(crate::models::ErrorDetail),
    Status401(crate::models::ErrorDetail),
    Status403(crate::models::ErrorDetail),
...
pub async fn janus_stream_key_update_or_create(configuration: &configuration::Configuration, device_id: i32, janus_stream_request: Option<crate::models::JanusStreamRequest>) -> Result<crate::models::JanusStream, Error<JanusStreamKeyUpdateOrCreateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<JanusStreamKeyUpdateOrCreateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
