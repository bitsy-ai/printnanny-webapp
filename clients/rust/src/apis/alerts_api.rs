...
/// struct for typed errors of method [`alerts_create`]
...
pub async fn alerts_create(configuration: &configuration::Configuration, alert_request: Option<crate::models::AlertRequest>) -> Result<crate::models::Alert, Error<AlertsCreateError>> {
