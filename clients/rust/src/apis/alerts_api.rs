...
pub async fn alerts_print_job_create(configuration: &configuration::Configuration, event_type: crate::models::EventTypeEnum, event_source: crate::models::EventSourceEnum, pi: i32, email_message_id: Option<&str>, image: Option<std::path::PathBuf>) -> Result<crate::models::PrintJobAlert, Error<AlertsPrintJobCreateError>> {
    let local_var_configuration = configuration;
...
pub async fn alerts_print_job_update(configuration: &configuration::Configuration, id: &str, event_type: crate::models::EventTypeEnum, event_source: crate::models::EventSourceEnum, pi: i32, email_message_id: Option<&str>, image: Option<std::path::PathBuf>) -> Result<crate::models::PrintJobAlert, Error<AlertsPrintJobUpdateError>> {
    let local_var_configuration = configuration;
