...
pub async fn alerts_print_job_create(configuration: &configuration::Configuration, event_type: crate::models::EventTypeEnum, event_source: crate::models::EventSourceEnum, pi: i32, email_message_id: Option<&str>, celery_task_id: Option<&str>, image: Option<std::path::PathBuf>) -> Result<crate::models::PrintJobAlert, Error<AlertsPrintJobCreateError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(local_var_param_value) = email_message_id {
        local_var_form = local_var_form.text("email_message_id", local_var_param_value.to_string());
    }
    if let Some(local_var_param_value) = celery_task_id {
        local_var_form = local_var_form.text("celery_task_id", local_var_param_value.to_string());
    }
...
pub async fn alerts_print_job_partial_update(configuration: &configuration::Configuration, id: &str, event_type: Option<crate::models::EventTypeEnum>, event_source: Option<crate::models::EventSourceEnum>, email_message_id: Option<&str>, celery_task_id: Option<&str>, image: Option<std::path::PathBuf>, pi: Option<i32>) -> Result<crate::models::PrintJobAlert, Error<AlertsPrintJobPartialUpdateError>> {
    let local_var_configuration = configuration;
...
pub async fn alerts_print_job_update(configuration: &configuration::Configuration, id: &str, event_type: crate::models::EventTypeEnum, event_source: crate::models::EventSourceEnum, pi: i32, email_message_id: Option<&str>, celery_task_id: Option<&str>, image: Option<std::path::PathBuf>) -> Result<crate::models::PrintJobAlert, Error<AlertsPrintJobUpdateError>> {
    let local_var_configuration = configuration;
