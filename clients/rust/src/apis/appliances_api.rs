...
/// struct for typed errors of method [`appliances_keypairs_create`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AppliancesKeypairsCreateError {
    DefaultResponse(crate::models::ErrorDetail),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`appliances_keypairs_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AppliancesKeypairsListError {
    DefaultResponse(crate::models::ErrorDetail),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`appliances_keypairs_retrieve`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AppliancesKeypairsRetrieveError {
    UnknownValue(serde_json::Value),
}
...
pub async fn appliances_keypairs_create(configuration: &configuration::Configuration, appliance_id: i32) -> Result<crate::models::ApplianceKeyPair, Error<AppliancesKeypairsCreateError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/appliances/{appliance_id}/keypairs/", local_var_configuration.base_path, appliance_id=appliance_id);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AppliancesKeypairsCreateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
/// Public key for Print Nanny Appliance Only one public key may be active at a time DELETE <:endpoint> will soft-delete a key
pub async fn appliances_keypairs_list(configuration: &configuration::Configuration, appliance_id: i32, page: Option<i32>) -> Result<crate::models::PaginatedAppliancePublicKeyList, Error<AppliancesKeypairsListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AppliancesKeypairsListError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
/// Public key for Print Nanny Appliance Only one public key may be active at a time DELETE <:endpoint> will soft-delete a key
pub async fn appliances_keypairs_retrieve(configuration: &configuration::Configuration, appliance_id: i32, id: i32) -> Result<crate::models::AppliancePublicKey, Error<AppliancesKeypairsRetrieveError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/appliances/{appliance_id}/keypairs/{id}/", local_var_configuration.base_path, appliance_id=appliance_id, id=id);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AppliancesKeypairsRetrieveError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
