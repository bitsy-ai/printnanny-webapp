...
*DevicesApi* | [**devices_state_list**](docs/DevicesApi.md#devices_state_list) | **GET** /api/devices/{device_id}/state/ | 
*DevicesApi* | [**devices_state_retrieve**](docs/DevicesApi.md#devices_state_retrieve) | **GET** /api/devices/{device_id}/state/{id}/ | 
...
## Documentation For Models
 ...
 - [PaginatedDeviceStateList](docs/PaginatedDeviceStateList.md)
