...
*DevicesApi* | [**license_activate**](docs/DevicesApi.md#license_activate) | **POST** /api/devices/{device_id}/tasks/{id}/task_retrieve_or_create/ | 
*LicensesApi* | [**license_activate2**](docs/LicensesApi.md#license_activate2) | **POST** /api/licenses/{id}/activate/ | 
