...
*DevicesApi* | [**devices_tasks_status_partial_update**](docs/DevicesApi.md#devices_tasks_status_partial_update) | **PATCH** /api/devices/{device_id}/tasks/{task_id}/status/{id}/ | 
...
*DevicesApi* | [**devices_tasks_status_update**](docs/DevicesApi.md#devices_tasks_status_update) | **PUT** /api/devices/{device_id}/tasks/{task_id}/status/{id}/ | 
...
## Documentation For Models
 ...
 - [PatchedTaskStatusRequest](docs/PatchedTaskStatusRequest.md)
