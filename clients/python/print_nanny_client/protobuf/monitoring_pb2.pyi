...
class Box(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    XY0_XY1_FIELD_NUMBER: builtins.int
    xy0_xy1: google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.float] = ...

    def __init__(self,
        *,
        xy0_xy1 : typing.Optional[typing.Iterable[builtins.float]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"xy0_xy1",b"xy0_xy1"]) -> None: ...
global___Box = Box
...
class DeviceCalibration(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"coordinates",b"coordinates",u"fps",b"fps"]) -> None: ...
