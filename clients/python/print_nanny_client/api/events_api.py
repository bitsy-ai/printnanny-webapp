...
class EventsApi(object):
    ...
    def octoprint_events_telemetry_retrieve(self, **kwargs):  # noqa: E501
        """octoprint_events_telemetry_retrieve  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.octoprint_events_telemetry_retrieve(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.octoprint_events_telemetry_retrieve_with_http_info(**kwargs)  # noqa: E501

    def octoprint_events_telemetry_retrieve_with_http_info(self, **kwargs):  # noqa: E501
        """octoprint_events_telemetry_retrieve  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.octoprint_events_telemetry_retrieve_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method octoprint_events_telemetry_retrieve" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
