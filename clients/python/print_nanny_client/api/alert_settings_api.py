...
class AlertSettingsApi(object):
    ...
    def alert_settings_alert_methods_retrieve(self, **kwargs):  # noqa: E501
        """alert_settings_alert_methods_retrieve  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.alert_settings_alert_methods_retrieve(async_req=True)
        >>> result = thread.get()
        ...
        return self.alert_settings_alert_methods_retrieve_with_http_info(**kwargs)  # noqa: E501

    def alert_settings_alert_methods_retrieve_with_http_info(self, **kwargs):  # noqa: E501
        """alert_settings_alert_methods_retrieve  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.alert_settings_alert_methods_retrieve_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(AlertMethod, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method alert_settings_alert_methods_retrieve" % key
                )
        ...
        return self.api_client.call_api(
            '/api/alert_settings/alert_methods/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def alert_settings_list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PaginatedAlertSettingsPolymorphicList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        response_types_map = {
            200: "PaginatedAlertSettingsPolymorphicList",
        }

        return self.api_client.call_api(
            '/api/alert_settings/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def alert_settings_partial_update(self, id, **kwargs):  # noqa: E501
        ...
        :type id: int
        :param patched_alert_settings_polymorphic_request:
        :type patched_alert_settings_polymorphic_request: PatchedAlertSettingsPolymorphicRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def alert_settings_partial_update_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(AlertSettingsPolymorphic, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        all_params = [
            'id',
            'patched_alert_settings_polymorphic_request'
        ]
        all_params.extend(
            [
                'async_req',
        ...
        body_params = None
        if 'patched_alert_settings_polymorphic_request' in local_var_params:
            body_params = local_var_params['patched_alert_settings_polymorphic_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        response_types_map = {
            200: "AlertSettingsPolymorphic",
        }

        return self.api_client.call_api(
            '/api/alert_settings/{id}/', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def alert_settings_update(self, id, **kwargs):  # noqa: E501
        ...
        :param id: A unique integer value identifying this alert settings. (required)
        :type id: int
        :param alert_settings_polymorphic_request:
        :type alert_settings_polymorphic_request: AlertSettingsPolymorphicRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def alert_settings_update_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        all_params = [
            'id',
            'alert_settings_polymorphic_request'
        ]
        all_params.extend(
            [
                'async_req',
        ...
        body_params = None
        if 'alert_settings_polymorphic_request' in local_var_params:
            body_params = local_var_params['alert_settings_polymorphic_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
