...
class DevicesApi(object):
    ...
    def octoprint_devices_update(self, id, device_request, **kwargs):  # noqa: E501
        """octoprint_devices_update  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.octoprint_devices_update(id, device_request, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.octoprint_devices_update_with_http_info(id, device_request, **kwargs)  # noqa: E501

    def octoprint_devices_update_with_http_info(self, id, device_request, **kwargs):  # noqa: E501
        """octoprint_devices_update  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.octoprint_devices_update_with_http_info(id, device_request, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('device_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['device_request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `device_request` when calling `octoprint_devices_update`")  # noqa: E501
