...
class MonitoringFrameT(object):
    ...
    def _UnPack(self, monitoringFrame):
        ...
        if monitoringFrame.Image() is not None:
            self.image = print_nanny_client.flatbuffers.monitoring.Image.ImageT.InitFromObj(monitoringFrame.Image())
        if monitoringFrame.BoundingBoxes() is not None:
            self.boundingBoxes = print_nanny_client.flatbuffers.monitoring.BoundingBoxes.BoundingBoxesT.InitFromObj(monitoringFrame.BoundingBoxes())
