...
class RemoteControlCommandAlert(object):
    ...
    def __init__(self, alert_subtype=None, alert_method=None, alert_type=None, color=None, created_dt=None, dashboard_url=None, dismissed=None, metadata=None, icon=None, id=None, time=None, description=None, seen=None, snapshot_url=None, title=None, updated_dt=None, user=None, local_vars_configuration=None):  # noqa: E501
