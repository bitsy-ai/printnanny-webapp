...
class PrintNannyPluginEventEventTypeEnum(object):
    ...
    allowable_values = [PLUGIN_OCTOPRINT_NANNY_MONITORING_START, PLUGIN_OCTOPRINT_NANNY_MONITORING_STOP, PLUGIN_OCTOPRINT_NANNY_MONITORING_RESET, PLUGIN_OCTOPRINT_NANNY_DEVICE_REGISTER_START, PLUGIN_OCTOPRINT_NANNY_DEVICE_REGISTER_DONE, PLUGIN_OCTOPRINT_NANNY_DEVICE_REGISTER_FAILED, DEVICE_RESET, PLUGIN_OCTOPRINT_NANNY_PRINTER_PROFILE_SYNC_START, PLUGIN_OCTOPRINT_NANNY_PRINTER_PROFILE_SYNC_DONE, PLUGIN_OCTOPRINT_NANNY_PRINTER_PROFILE_SYNC_FAILED, CONNECT_TEST_REST_API, PLUGIN_OCTOPRINT_NANNY_CONNECT_TEST_REST_API_FAILED, PLUGIN_OCTOPRINT_NANNY_CONNECT_TEST_REST_API_SUCCESS, PLUGIN_OCTOPRINT_NANNY_CONNECT_TEST_MQTT_PING, PLUGIN_OCTOPRINT_NANNY_CONNECT_TEST_MQTT_PING_FAILED, PLUGIN_OCTOPRINT_NANNY_CONNECT_TEST_MQTT_PING_SUCCESS, PLUGIN_OCTOPRINT_NANNY_CONNECT_TEST_MQTT_PONG, PLUGIN_OCTOPRINT_NANNY_CONNECT_TEST_MQTT_PONG_FAILED, PLUGIN_OCTOPRINT_NANNY_CONNECT_TEST_MQTT_PONG_SUCCESS]  # noqa: E501
