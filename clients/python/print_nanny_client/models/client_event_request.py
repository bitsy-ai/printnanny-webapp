...
class ClientEventRequest(object):
    ...
    def __init__(self, client_event_type=None, event_data=None, device=None, plugin_version=None, octoprint_version=None, local_vars_configuration=None):  # noqa: E501
