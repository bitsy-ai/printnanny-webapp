...
class CommandAlertSettings(object):
    ...
    def __init__(self, id=None, created_dt=None, updated_dt=None, alert_type=None, alert_methods=None, enabled=None, monitoring_stop=None, monitoring_start=None, print_start=None, print_stop=None, print_pause=None, print_resume=None, move_nozzle=None, polymorphic_ctype=None, user=None, local_vars_configuration=None):  # noqa: E501
