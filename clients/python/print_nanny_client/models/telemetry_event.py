...
class TelemetryEvent(object):
    ...
    def __init__(self, id=None, print_session=None, event_type=None, environment=None, octoprint_job=None, created_dt=None, event_source=None, event_data=None, plugin_version=None, client_version=None, octoprint_version=None, metadata=None, polymorphic_ctype=None, octoprint_device=None, user=None, local_vars_configuration=None):  # noqa: E501
