...
import print_nanny_client.telemetry_event.Image
try:
...
class MonitoringFrameT(object):
    ...
    def _UnPack(self, monitoringFrame):
        ...
        if monitoringFrame.BoundingBoxes() is not None:
            self.boundingBoxes = print_nanny_client.telemetry_event.BoundingBoxes.BoundingBoxesT.InitFromObj(monitoringFrame.BoundingBoxes())
