...
from ...models.resend_email_verification_request import ResendEmailVerificationRequest
...
def _get_kwargs(
    *,
    ...
    multipart_data: ResendEmailVerificationRequest,
    json_body: ResendEmailVerificationRequest,
) -> Dict[str, Any]:
    url = "{}/api/accounts/registration/resend-email/".format(client.base_url)
