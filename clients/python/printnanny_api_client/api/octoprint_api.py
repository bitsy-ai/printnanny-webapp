...
class OctoprintApi(object):
    ...
    def pis_octoprint_list(self, device_id, pi_id, **kwargs):  # noqa: E501
        """pis_octoprint_list  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.pis_octoprint_list(device_id, pi_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.pis_octoprint_list_with_http_info(device_id, pi_id, **kwargs)  # noqa: E501

    def pis_octoprint_list_with_http_info(self, device_id, pi_id, **kwargs):  # noqa: E501
        """pis_octoprint_list  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.pis_octoprint_list_with_http_info(device_id, pi_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('device_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `device_id` when calling `pis_octoprint_list`")  # noqa: E501
