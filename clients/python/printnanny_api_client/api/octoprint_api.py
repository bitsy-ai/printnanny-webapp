...
class OctoprintApi(object):
    ...
    def octoprint_events_create(self, **kwargs):  # noqa: E501
        ...
        :param polymorphic_octo_print_event_request:
        :type polymorphic_octo_print_event_request: PolymorphicOctoPrintEventRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: PolymorphicOctoPrintEvent
        """
        kwargs['_return_http_data_only'] = True
    ...
    def octoprint_events_create_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PolymorphicOctoPrintEvent, status_code(int), headers(HTTPHeaderDict))
        """

        local_var_params = locals()

        all_params = [
            'polymorphic_octo_print_event_request'
        ]
        all_params.extend(
            [
                'async_req',
        ...
        body_params = None
        if 'polymorphic_octo_print_event_request' in local_var_params:
            body_params = local_var_params['polymorphic_octo_print_event_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def octoprint_events_list(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: PaginatedPolymorphicOctoPrintEventList
        """
        kwargs['_return_http_data_only'] = True
    ...
    def octoprint_events_list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PaginatedPolymorphicOctoPrintEventList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        response_types_map = {
            200: "PaginatedPolymorphicOctoPrintEventList",
            400: "ErrorDetail",
            401: "ErrorDetail",
            403: "ErrorDetail",
            500: "ErrorDetail",
    ...
    def octoprint_events_retrieve(self, id, **kwargs):  # noqa: E501
        ...
        :param id: A UUID string identifying this base octo print event. (required)
        :type id: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
    ...
    def pis_octoprint_server_list(self, pi_id, **kwargs):  # noqa: E501
        """pis_octoprint_server_list  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.pis_octoprint_server_list(pi_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.pis_octoprint_server_list_with_http_info(pi_id, **kwargs)  # noqa: E501

    def pis_octoprint_server_list_with_http_info(self, pi_id, **kwargs):  # noqa: E501
        """pis_octoprint_server_list  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.pis_octoprint_server_list_with_http_info(pi_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method pis_octoprint_server_list" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('pi_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `pi_id` when calling `pis_octoprint_server_list`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/pis/{pi_id}/octoprint-server/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
