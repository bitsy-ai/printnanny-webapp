...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[ErrorDetail, OctoPrintServer]]:
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = OctoPrintServer.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[ErrorDetail, OctoPrintServer]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    multipart_data: OctoPrintServerRequest,
    json_body: OctoPrintServerRequest,
) -> Response[Union[ErrorDetail, OctoPrintServer]]:
    """
    Args:
        id (int):
        multipart_data (OctoPrintServerRequest):
...
def sync(
    ...
    *,
    ...
    multipart_data: OctoPrintServerRequest,
    json_body: OctoPrintServerRequest,
) -> Optional[Union[ErrorDetail, OctoPrintServer]]:
    """
    Args:
        id (int):
        multipart_data (OctoPrintServerRequest):
