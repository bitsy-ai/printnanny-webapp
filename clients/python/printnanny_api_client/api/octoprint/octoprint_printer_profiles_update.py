...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/octoprint/printer-profiles/{id}/".format(client.base_url, id=id)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[ErrorDetail, OctoPrinterProfile]]:
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = OctoPrinterProfile.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[ErrorDetail, OctoPrinterProfile]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    multipart_data: OctoPrinterProfileRequest,
    json_body: OctoPrinterProfileRequest,
) -> Response[Union[ErrorDetail, OctoPrinterProfile]]:
    """
    Args:
        id (int):
        multipart_data (OctoPrinterProfileRequest):
...
def sync(
    ...
    *,
    ...
    multipart_data: OctoPrinterProfileRequest,
    json_body: OctoPrinterProfileRequest,
) -> Optional[Union[ErrorDetail, OctoPrinterProfile]]:
    """
    Args:
        id (int):
        multipart_data (OctoPrinterProfileRequest):
