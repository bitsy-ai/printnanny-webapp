...
from ...models.patched_webrtc_stream_request import PatchedWebrtcStreamRequest
...
def _get_kwargs(
    ...
    *,
    ...
    form_data: PatchedWebrtcStreamRequest,
    multipart_data: PatchedWebrtcStreamRequest,
    json_body: PatchedWebrtcStreamRequest,
) -> Dict[str, Any]:
