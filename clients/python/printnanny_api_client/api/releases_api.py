...
class ReleasesApi(object):
    ...
    def releases_list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PaginatedReleaseList, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def releases_retrieve(self, id, **kwargs):  # noqa: E501
        """releases_retrieve  # noqa: E501

        All-in-one Print Nanny installation via print-nanny-main-<platform>-<cpu>.img  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.releases_retrieve(id, async_req=True)
        >>> result = thread.get()

        :param id: A unique integer value identifying this release. (required)
        :type id: int
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.releases_retrieve_with_http_info(id, **kwargs)  # noqa: E501

    def releases_retrieve_with_http_info(self, id, **kwargs):  # noqa: E501
        """releases_retrieve  # noqa: E501
        ...
        >>> thread = api.releases_retrieve_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method releases_retrieve" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `releases_retrieve`")  # noqa: E501
