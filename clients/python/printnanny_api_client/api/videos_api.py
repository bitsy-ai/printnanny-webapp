...
class VideosApi(object):
    ...
    def video_recording_parts_update_or_create(self, video_recording_part_request, **kwargs):  # noqa: E501
        """video_recording_parts_update_or_create  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.video_recording_parts_update_or_create(video_recording_part_request, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.video_recording_parts_update_or_create_with_http_info(video_recording_part_request, **kwargs)  # noqa: E501

    def video_recording_parts_update_or_create_with_http_info(self, video_recording_part_request, **kwargs):  # noqa: E501
        """video_recording_parts_update_or_create  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.video_recording_parts_update_or_create_with_http_info(video_recording_part_request, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/video-parts/update-or-create/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
