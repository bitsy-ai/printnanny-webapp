...
class VideosApi(object):
    ...
    def video_recordings_finalize(self, id, **kwargs):  # noqa: E501
        """video_recordings_finalize  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.video_recordings_finalize(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.video_recordings_finalize_with_http_info(id, **kwargs)  # noqa: E501

    def video_recordings_finalize_with_http_info(self, id, **kwargs):  # noqa: E501
        """video_recordings_finalize  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.video_recordings_finalize_with_http_info(id, async_req=True)
        >>> result = thread.get()
