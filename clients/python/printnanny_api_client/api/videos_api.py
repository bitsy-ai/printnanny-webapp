...
class VideosApi(object):
    ...
    def video_parts_create(self, id, size, buffer_index, buffer_runningtime, file_name, video_recording, **kwargs):  # noqa: E501
        """video_parts_create  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.video_parts_create(id, size, buffer_index, buffer_runningtime, file_name, video_recording, async_req=True)
        >>> result = thread.get()
        ...
        return self.video_parts_create_with_http_info(id, size, buffer_index, buffer_runningtime, file_name, video_recording, **kwargs)  # noqa: E501

    def video_parts_create_with_http_info(self, id, size, buffer_index, buffer_runningtime, file_name, video_recording, **kwargs):  # noqa: E501
        """video_parts_create  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.video_parts_create_with_http_info(id, size, buffer_index, buffer_runningtime, file_name, video_recording, async_req=True)
        >>> result = thread.get()
