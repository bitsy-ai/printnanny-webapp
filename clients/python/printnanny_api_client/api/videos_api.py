...
class VideosApi(object):
    ...
    def video_recordings_update_or_create(self, id, video_recording_part_request, **kwargs):  # noqa: E501
        """video_recordings_update_or_create  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.video_recordings_update_or_create(id, video_recording_part_request, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.video_recordings_update_or_create_with_http_info(id, video_recording_part_request, **kwargs)  # noqa: E501

    def video_recordings_update_or_create_with_http_info(self, id, video_recording_part_request, **kwargs):  # noqa: E501
        """video_recordings_update_or_create  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.video_recordings_update_or_create_with_http_info(id, video_recording_part_request, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('video_recording_part_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['video_recording_part_request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `video_recording_part_request` when calling `video_recordings_update_or_create`")  # noqa: E501
    ...
    def video_recordings_update_or_create2(self, id, **kwargs):  # noqa: E501
        """video_recordings_update_or_create2  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.video_recordings_update_or_create2(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.video_recordings_update_or_create2_with_http_info(id, **kwargs)  # noqa: E501

    def video_recordings_update_or_create2_with_http_info(self, id, **kwargs):  # noqa: E501
        """video_recordings_update_or_create2  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.video_recordings_update_or_create2_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method video_recordings_update_or_create2" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `video_recordings_update_or_create2`")  # noqa: E501
