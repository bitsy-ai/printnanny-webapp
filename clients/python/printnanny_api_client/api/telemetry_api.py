...
class TelemetryApi(object):
    ...
    def print_job_events_list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PaginatedPrintJobEventList, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def print_job_events_retrieve_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PrintJobEvent, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def telemetry_events_create(self, **kwargs):  # noqa: E501
        """telemetry_events_create  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.telemetry_events_create(async_req=True)
        >>> result = thread.get()

        :param telemetry_event_polymorphic_request:
        :type telemetry_event_polymorphic_request: TelemetryEventPolymorphicRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.telemetry_events_create_with_http_info(**kwargs)  # noqa: E501

    def telemetry_events_create_with_http_info(self, **kwargs):  # noqa: E501
        """telemetry_events_create  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.telemetry_events_create_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = [
            'telemetry_event_polymorphic_request'
        ]
        all_params.extend(
            [
                'async_req',
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method telemetry_events_create" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        body_params = None
        if 'telemetry_event_polymorphic_request' in local_var_params:
            body_params = local_var_params['telemetry_event_polymorphic_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
