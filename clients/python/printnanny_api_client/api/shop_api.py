...
class ShopApi(object):
    ...
    def cloud_plans_retrieve(self, **kwargs):  # noqa: E501
        """cloud_plans_retrieve  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.cloud_plans_retrieve(async_req=True)
        >>> result = thread.get()
        ...
        return self.cloud_plans_retrieve_with_http_info(**kwargs)  # noqa: E501

    def cloud_plans_retrieve_with_http_info(self, **kwargs):  # noqa: E501
        """cloud_plans_retrieve  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.cloud_plans_retrieve_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method cloud_plans_retrieve" % key
                )
        ...
        return self.api_client.call_api(
            '/api/shop/products/cloud-plans/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def shop_orders_create(self, order_checkout_request_request, **kwargs):  # noqa: E501
        """shop_orders_create  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.shop_orders_create(order_checkout_request_request, async_req=True)
        >>> result = thread.get()

        :param order_checkout_request_request: (required)
        :type order_checkout_request_request: OrderCheckoutRequestRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.shop_orders_create_with_http_info(order_checkout_request_request, **kwargs)  # noqa: E501

    def shop_orders_create_with_http_info(self, order_checkout_request_request, **kwargs):  # noqa: E501
        """shop_orders_create  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.shop_orders_create_with_http_info(order_checkout_request_request, async_req=True)
        >>> result = thread.get()
        ...
        all_params = [
            'order_checkout_request_request'
        ]
        all_params.extend(
            [
                'async_req',
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            ...
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'order_checkout_request_request' is set
        if self.api_client.client_side_validation and ('order_checkout_request_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['order_checkout_request_request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `order_checkout_request_request` when calling `shop_orders_create`")  # noqa: E501
        ...
        body_params = None
        if 'order_checkout_request_request' in local_var_params:
            body_params = local_var_params['order_checkout_request_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
