...
class ShopApi(object):
    ...
    def shop_products_retrieve(self, sku, **kwargs):  # noqa: E501
        """shop_products_retrieve  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.shop_products_retrieve(sku, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.shop_products_retrieve_with_http_info(sku, **kwargs)  # noqa: E501

    def shop_products_retrieve_with_http_info(self, sku, **kwargs):  # noqa: E501
        """shop_products_retrieve  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.shop_products_retrieve_with_http_info(sku, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method shop_products_retrieve" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'sku' is set
        if self.api_client.client_side_validation and ('sku' not in local_var_params or  # noqa: E501
                                                        local_var_params['sku'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `sku` when calling `shop_products_retrieve`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'sku' in local_var_params:
            path_params['sku'] = local_var_params['sku']  # noqa: E501
