...
class DevicesApi(object):
    ...
    def devices_licenses_activate_update(self, device_id, id, license_request, **kwargs):  # noqa: E501
        """devices_licenses_activate_update  # noqa: E501

        All-in-one Print Nanny installation via print-nanny-main-<platform>-<cpu>.img  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.devices_licenses_activate_update(device_id, id, license_request, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.devices_licenses_activate_update_with_http_info(device_id, id, license_request, **kwargs)  # noqa: E501

    def devices_licenses_activate_update_with_http_info(self, device_id, id, license_request, **kwargs):  # noqa: E501
        """devices_licenses_activate_update  # noqa: E501
        ...
        >>> thread = api.devices_licenses_activate_update_with_http_info(device_id, id, license_request, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method devices_licenses_activate_update" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'device_id' is set
        if self.api_client.client_side_validation and ('device_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['device_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `device_id` when calling `devices_licenses_activate_update`")  # noqa: E501
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `devices_licenses_activate_update`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('license_request' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `license_request` when calling `devices_licenses_activate_update`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/devices/{device_id}/licenses/{id}/activate/', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def devices_licenses_list(self, device_id, **kwargs):  # noqa: E501
        """devices_licenses_list  # noqa: E501

        All-in-one Print Nanny installation via print-nanny-main-<platform>-<cpu>.img  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.devices_licenses_list(device_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.devices_licenses_list_with_http_info(device_id, **kwargs)  # noqa: E501

    def devices_licenses_list_with_http_info(self, device_id, **kwargs):  # noqa: E501
        """devices_licenses_list  # noqa: E501
        ...
        >>> thread = api.devices_licenses_list_with_http_info(device_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method devices_licenses_list" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'device_id' is set
        if self.api_client.client_side_validation and ('device_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['device_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `device_id` when calling `devices_licenses_list`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/devices/{device_id}/licenses/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
