...
class DevicesApi(object):
    ...
    def pis_config_download_retrieve(self, pi_id, **kwargs):  # noqa: E501
        """pis_config_download_retrieve  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.pis_config_download_retrieve(pi_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.pis_config_download_retrieve_with_http_info(pi_id, **kwargs)  # noqa: E501

    def pis_config_download_retrieve_with_http_info(self, pi_id, **kwargs):  # noqa: E501
        """pis_config_download_retrieve  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.pis_config_download_retrieve_with_http_info(pi_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method pis_config_download_retrieve" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'pi_id' is set
        if self.api_client.client_side_validation and ('pi_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['pi_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `pi_id` when calling `pis_config_download_retrieve`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/pis/{pi_id}/config/download/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
