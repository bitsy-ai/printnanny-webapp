...
class PolymorphicPiEvent(object):
    ...
    def __init__(self, id=None, created_dt=None, subject=None, payload=None, event_type=None, polymorphic_ctype=None, pi=None, version=None, local_vars_configuration=None):  # noqa: E501
