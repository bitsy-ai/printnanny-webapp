...
class PatchedDeviceInfoRequest(object):
    ...
    def __init__(self, machine_id=None, hardware=None, revision=None, model=None, serial=None, cores=None, ram=None, image_version=None, device=None, local_vars_configuration=None):  # noqa: E501
        """PatchedDeviceInfoRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def machine_id(self):
        """Gets the machine_id of this PatchedDeviceInfoRequest.  # noqa: E501

        Populated from /etc/machine-id  # noqa: E501

        :return: The machine_id of this PatchedDeviceInfoRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def machine_id(self, machine_id):
        """Sets the machine_id of this PatchedDeviceInfoRequest.

        Populated from /etc/machine-id  # noqa: E501

        :param machine_id: The machine_id of this PatchedDeviceInfoRequest.  # noqa: E501
        :type machine_id: str
        """
    ...
    @property
    def hardware(self):
        """Gets the hardware of this PatchedDeviceInfoRequest.  # noqa: E501

        Populated from /proc/cpuinfo HARDWARE  # noqa: E501

        :return: The hardware of this PatchedDeviceInfoRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def hardware(self, hardware):
        """Sets the hardware of this PatchedDeviceInfoRequest.

        Populated from /proc/cpuinfo HARDWARE  # noqa: E501

        :param hardware: The hardware of this PatchedDeviceInfoRequest.  # noqa: E501
        :type hardware: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def revision(self):
        """Gets the revision of this PatchedDeviceInfoRequest.  # noqa: E501

        Populated from /proc/cpuinfo REVISION  # noqa: E501

        :return: The revision of this PatchedDeviceInfoRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def revision(self, revision):
        """Sets the revision of this PatchedDeviceInfoRequest.

        Populated from /proc/cpuinfo REVISION  # noqa: E501

        :param revision: The revision of this PatchedDeviceInfoRequest.  # noqa: E501
        :type revision: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def model(self):
        """Gets the model of this PatchedDeviceInfoRequest.  # noqa: E501

        Populated from /proc/cpuinfo MODEL  # noqa: E501

        :return: The model of this PatchedDeviceInfoRequest.  # noqa: E501
        :rtype: str
        """
        return self._model
    ...
    def model(self, model):
        """Sets the model of this PatchedDeviceInfoRequest.

        Populated from /proc/cpuinfo MODEL  # noqa: E501

        :param model: The model of this PatchedDeviceInfoRequest.  # noqa: E501
        :type model: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def serial(self):
        """Gets the serial of this PatchedDeviceInfoRequest.  # noqa: E501

        Populated from /proc/cpuinfo SERIAL  # noqa: E501

        :return: The serial of this PatchedDeviceInfoRequest.  # noqa: E501
        :rtype: str
        """
        return self._serial
    ...
    def serial(self, serial):
        """Sets the serial of this PatchedDeviceInfoRequest.

        Populated from /proc/cpuinfo SERIAL  # noqa: E501

        :param serial: The serial of this PatchedDeviceInfoRequest.  # noqa: E501
        :type serial: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def cores(self):
        """Gets the cores of this PatchedDeviceInfoRequest.  # noqa: E501


        :return: The cores of this PatchedDeviceInfoRequest.  # noqa: E501
        :rtype: int
        """
        return self._cores
    ...
    def cores(self, cores):
        """Sets the cores of this PatchedDeviceInfoRequest.


        :param cores: The cores of this PatchedDeviceInfoRequest.  # noqa: E501
        :type cores: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def ram(self):
        """Gets the ram of this PatchedDeviceInfoRequest.  # noqa: E501


        :return: The ram of this PatchedDeviceInfoRequest.  # noqa: E501
        :rtype: int
        """
        return self._ram
    ...
    @ram.setter
    def ram(self, ram):
        """Sets the ram of this PatchedDeviceInfoRequest.


        :param ram: The ram of this PatchedDeviceInfoRequest.  # noqa: E501
        :type ram: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def image_version(self):
        """Gets the image_version of this PatchedDeviceInfoRequest.  # noqa: E501

        Print Nanny OS version string from /boot/image_version.txt  # noqa: E501

        :return: The image_version of this PatchedDeviceInfoRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def image_version(self, image_version):
        """Sets the image_version of this PatchedDeviceInfoRequest.

        Print Nanny OS version string from /boot/image_version.txt  # noqa: E501

        :param image_version: The image_version of this PatchedDeviceInfoRequest.  # noqa: E501
    ...
    @property
    def device(self):
        """Gets the device of this PatchedDeviceInfoRequest.  # noqa: E501


        :return: The device of this PatchedDeviceInfoRequest.  # noqa: E501
        :rtype: int
        """
        return self._device
    ...
    def device(self, device):
        """Sets the device of this PatchedDeviceInfoRequest.


        :param device: The device of this PatchedDeviceInfoRequest.  # noqa: E501
        :type device: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchedDeviceInfoRequest):
            return False
