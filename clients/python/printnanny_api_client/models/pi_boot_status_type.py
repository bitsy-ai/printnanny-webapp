...
class PiBootStatusType(object):
    ...
    allowable_values = [REBOOTSTARTED, REBOOTERROR, SHUTDOWNSTARTED, SHUTDOWNERROR, BOOTSTARTED, BOOTSUCCESS, BOOTDEGRADED, SYNCSETTINGSSTARTED, SYNCSETTINGSSUCCESS, SYNCSETTINGSERROR]  # noqa: E501
