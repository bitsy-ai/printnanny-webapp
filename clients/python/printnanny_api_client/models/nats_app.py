...
class NatsApp(object):
    ...
    def __init__(self, id=None, name=None, json=None, pi=None, organization=None, organization_user=None, nats_uri=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this NatsApp.  # noqa: E501


        :return: The name of this NatsApp.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this NatsApp.


        :param name: The name of this NatsApp.  # noqa: E501
        :type name: str
        """
