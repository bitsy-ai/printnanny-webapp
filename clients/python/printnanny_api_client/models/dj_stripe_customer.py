...
class DjStripeCustomer(object):
    ...
    def tax_exempt(self):
        ...
        Describes the customer's tax exemption status. When set to reverse, invoice and receipt PDFs include the text \"Reverse charge\".  * `exempt` - Exempt * `none` - None * `reverse` - Reverse  # noqa: E501
