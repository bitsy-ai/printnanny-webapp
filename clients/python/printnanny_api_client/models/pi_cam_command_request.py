...
if TYPE_CHECKING:
    from ..models.pi_cam_command_request_payload import PiCamCommandRequestPayload


T = TypeVar("T", bound="PiCamCommandRequest")


@attr.s(auto_attribs=True)
class PiCamCommandRequest:
    """
    Attributes:
        ...
        payload (Union[Unset, None, PiCamCommandRequestPayload]):
    """
    ...
    payload: Union[Unset, None, "PiCamCommandRequestPayload"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _payload is None:
            ...
            payload = PiCamCommandRequestPayload.from_dict(_payload)

        pi_cam_command_request = cls(
            subject_pattern=subject_pattern,
            event_type=event_type,
            pi=pi,
            id=id,
        ...
        pi_cam_command_request.additional_properties = d
        return pi_cam_command_request
