...
class WebrtcStream(object):
    ...
    def __init__(self, active=None, admin_port=None, admin_secret=None, admin_url=None, api_domain=None, api_port=None, api_token=None, api_url=None, config_type=None, created_dt=None, id=None, info=None, is_admin=None, pi=None, pt=None, rtp_domain=None, rtp_port=None, rtpmap=None, stream_pin=None, stream_secret=None, updated_dt=None, ws_port=None, ws_url=None, local_vars_configuration=None):  # noqa: E501
