...
T = TypeVar("T", bound="PaginatedPiList")


@attr.s(auto_attribs=True)
class PaginatedPiList:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in _results or []:
            results_item = Pi.from_dict(results_item_data)

            results.append(results_item)

        paginated_pi_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_pi_list.additional_properties = d
        return paginated_pi_list
