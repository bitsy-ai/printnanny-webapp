...
if TYPE_CHECKING:
    from ..models.pi_software_update_status_request_payload import PiSoftwareUpdateStatusRequestPayload


T = TypeVar("T", bound="PiSoftwareUpdateStatusRequest")


@attr.s(auto_attribs=True)
class PiSoftwareUpdateStatusRequest:
    """
    Attributes:
        ...
        payload (Union[Unset, None, PiSoftwareUpdateStatusRequestPayload]):
    """
    ...
    payload: Union[Unset, None, "PiSoftwareUpdateStatusRequestPayload"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _payload is None:
            ...
            payload = PiSoftwareUpdateStatusRequestPayload.from_dict(_payload)

        pi_software_update_status_request = cls(
            subject_pattern=subject_pattern,
            version=version,
            event_type=event_type,
            pi=pi,
        ...
        pi_software_update_status_request.additional_properties = d
        return pi_software_update_status_request
