...
T = TypeVar("T", bound="PaginatedPolymorphicPiStatusList")


@attr.s(auto_attribs=True)
class PaginatedPolymorphicPiStatusList:
    """
    Attributes:
        ...
        results (Union[Unset, List[Union['PiBootStatus', 'PiCamStatus', 'PiSoftwareUpdateStatus']]]):
    """

    count: Union[Unset, int] = UNSET
    next_: Union[Unset, None, str] = UNSET
    previous: Union[Unset, None, str] = UNSET
    results: Union[Unset, List[Union["PiBootStatus", "PiCamStatus", "PiSoftwareUpdateStatus"]]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in _results or []:
            ...
            def _parse_results_item(data: object) -> Union["PiBootStatus", "PiCamStatus", "PiSoftwareUpdateStatus"]:
                try:
        ...
        paginated_polymorphic_pi_status_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_polymorphic_pi_status_list.additional_properties = d
        return paginated_polymorphic_pi_status_list
