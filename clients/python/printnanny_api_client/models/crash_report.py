...
class CrashReport(object):
    ...
    def __init__(self, id=None, created_dt=None, description=None, email=None, os_version=None, os_logs=None, browser_version=None, browser_logs=None, serial=None, posthog_session=None, user=None, pi=None, related_crash_report=None, local_vars_configuration=None):  # noqa: E501
