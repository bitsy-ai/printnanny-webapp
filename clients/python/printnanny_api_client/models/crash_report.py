...
class CrashReport(object):
    ...
    def __init__(self, id=None, url=None, created_dt=None, description=None, email=None, os_version=None, os_logs=None, browser_version=None, browser_logs=None, serial=None, posthog_session=None, status=None, support_comment=None, user=None, pi=None, local_vars_configuration=None):  # noqa: E501
