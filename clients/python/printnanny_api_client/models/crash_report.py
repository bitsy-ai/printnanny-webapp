...
class CrashReport(object):
    ...
    def __init__(self, id=None, created_dt=None, email=None, os_version=None, os_logs=None, browser_version=None, browser_logs=None, user=None, pi=None, local_vars_configuration=None):  # noqa: E501
