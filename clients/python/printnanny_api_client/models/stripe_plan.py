...
class StripePlan(object):
    ...
    openapi_types = {
        ...
        'description': 'str',
        'active': 'bool',
        'aggregate_usage': 'OneOfAggregateUsageEnumBlankEnum',
        'amount': 'str',
        'amount_decimal': 'str',
        'billing_scheme': 'OneOfBillingSchemeEnumBlankEnum',
        'currency': 'str',
        'interval': 'IntervalEnum',
        'interval_count': 'int',
        'nickname': 'str',
        'tiers': 'dict(str, object)',
        'tiers_mode': 'OneOfTiersModeEnumBlankEnumNullEnum',
    ...
    def aggregate_usage(self):
        """Gets the aggregate_usage of this StripePlan.  # noqa: E501

        Specifies a usage aggregation strategy for plans of usage_type=metered. Allowed values are `sum` for summing up all usage during a period, `last_during_period` for picking the last usage record reported within a period, `last_ever` for picking the last usage record ever (across period bounds) or max which picks the usage record with the maximum reported usage during a period. Defaults to `sum`.  # noqa: E501

        :return: The aggregate_usage of this StripePlan.  # noqa: E501
        :rtype: OneOfAggregateUsageEnumBlankEnum
        """
        return self._aggregate_usage

    @aggregate_usage.setter
    def aggregate_usage(self, aggregate_usage):
        """Sets the aggregate_usage of this StripePlan.

        Specifies a usage aggregation strategy for plans of usage_type=metered. Allowed values are `sum` for summing up all usage during a period, `last_during_period` for picking the last usage record reported within a period, `last_ever` for picking the last usage record ever (across period bounds) or max which picks the usage record with the maximum reported usage during a period. Defaults to `sum`.  # noqa: E501

        :param aggregate_usage: The aggregate_usage of this StripePlan.  # noqa: E501
        :type aggregate_usage: OneOfAggregateUsageEnumBlankEnum
        """
    ...
    def billing_scheme(self):
        """Gets the billing_scheme of this StripePlan.  # noqa: E501

        Describes how to compute the price per period. Either `per_unit` or `tiered`. `per_unit` indicates that the fixed amount (specified in amount) will be charged per unit in quantity (for plans with `usage_type=licensed`), or per unit of total usage (for plans with `usage_type=metered`). `tiered` indicates that the unit pricing will be computed using a tiering strategy as defined using the tiers and tiers_mode attributes.  # noqa: E501

        :return: The billing_scheme of this StripePlan.  # noqa: E501
        :rtype: OneOfBillingSchemeEnumBlankEnum
        """
        return self._billing_scheme

    @billing_scheme.setter
    def billing_scheme(self, billing_scheme):
        """Sets the billing_scheme of this StripePlan.

        Describes how to compute the price per period. Either `per_unit` or `tiered`. `per_unit` indicates that the fixed amount (specified in amount) will be charged per unit in quantity (for plans with `usage_type=licensed`), or per unit of total usage (for plans with `usage_type=metered`). `tiered` indicates that the unit pricing will be computed using a tiering strategy as defined using the tiers and tiers_mode attributes.  # noqa: E501

        :param billing_scheme: The billing_scheme of this StripePlan.  # noqa: E501
        :type billing_scheme: OneOfBillingSchemeEnumBlankEnum
        """
    ...
    @property
    def tiers_mode(self):
        """Gets the tiers_mode of this StripePlan.  # noqa: E501

        Defines if the tiering price should be `graduated` or `volume` based. In `volume`-based tiering, the maximum quantity within a period determines the per unit price, in `graduated` tiering pricing can successively change as the quantity grows.  # noqa: E501

        :return: The tiers_mode of this StripePlan.  # noqa: E501
        :rtype: OneOfTiersModeEnumBlankEnumNullEnum
        """
        return self._tiers_mode

    @tiers_mode.setter
    def tiers_mode(self, tiers_mode):
        """Sets the tiers_mode of this StripePlan.

        Defines if the tiering price should be `graduated` or `volume` based. In `volume`-based tiering, the maximum quantity within a period determines the per unit price, in `graduated` tiering pricing can successively change as the quantity grows.  # noqa: E501

        :param tiers_mode: The tiers_mode of this StripePlan.  # noqa: E501
        :type tiers_mode: OneOfTiersModeEnumBlankEnumNullEnum
        """
