...
class PatchedOctoPrintServerRequest(object):
    ...
    def __init__(self, base_path=None, venv_path=None, pip_path=None, python_path=None, octoprint_version=None, pip_version=None, python_version=None, printnanny_plugin_version=None, api_key=None, pi=None, local_vars_configuration=None):  # noqa: E501
