...
if TYPE_CHECKING:
    from ..models.pi_cam_status_payload import PiCamStatusPayload


T = TypeVar("T", bound="PiCamStatus")
...
class PiCamStatus:
    ...
    Attributes:
        ...
        payload (Union[Unset, None, PiCamStatusPayload]):
    """
    ...
    payload: Union[Unset, None, "PiCamStatusPayload"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _payload is None:
            ...
            payload = PiCamStatusPayload.from_dict(_payload)
        ...
        pi_cam_status.additional_properties = d
        return pi_cam_status
