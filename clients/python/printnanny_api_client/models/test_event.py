...
class TestEvent(object):
    ...
    def __init__(self, id=None, event_type=None, created_dt=None, source=None, event_name=None, polymorphic_ctype=None, user=None, device=None, local_vars_configuration=None):  # noqa: E501
