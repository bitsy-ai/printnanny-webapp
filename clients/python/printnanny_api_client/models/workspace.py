...
class Workspace(object):
    ...
    def __init__(self, id=None, users=None, owner=None, pending_invites=None, name=None, is_active=None, created=None, modified=None, slug=None, description=None, icon=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def icon(self):
        """Gets the icon of this Workspace.  # noqa: E501


        :return: The icon of this Workspace.  # noqa: E501
        :rtype: str
        """
        return self._icon
    ...
    @icon.setter
    def icon(self, icon):
        """Sets the icon of this Workspace.


        :param icon: The icon of this Workspace.  # noqa: E501
        :type icon: str
        """
