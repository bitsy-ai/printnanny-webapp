...
class OctoPrintServerRequest(object):
    ...
    def __init__(self, octoprint_version=None, pip_version=None, python_version=None, printnanny_plugin_version=None, pi=None, local_vars_configuration=None):  # noqa: E501
