...
T = TypeVar("T", bound="PiSoftwareUpdatePayload")


@attr.s(auto_attribs=True)
class PiSoftwareUpdatePayload:
    """
    Attributes:
        wic_tarball_url (str):
        wic_bmap_url (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        pi_software_update_payload = cls(
            wic_tarball_url=wic_tarball_url,
            wic_bmap_url=wic_bmap_url,
            manifest_url=manifest_url,
            swu_url=swu_url,
        ...
        pi_software_update_payload.additional_properties = d
        return pi_software_update_payload
