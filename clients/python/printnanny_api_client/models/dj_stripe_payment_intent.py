...
class DjStripePaymentIntent(object):
    ...
    openapi_types = {
        ...
        'cancellation_reason': 'OneOfCancellationReasonEnumBlankEnum',
        ...
        'receipt_email': 'str',
        'setup_future_usage': 'OneOfSetupFutureUsageEnumBlankEnumNullEnum',
    ...
    def cancellation_reason(self):
        ...
        Reason for cancellation of this PaymentIntent, either user-provided (duplicate, fraudulent, requested_by_customer, or abandoned) or generated by Stripe internally (failed_invoice, void_invoice, or automatic).  # noqa: E501

        :return: The cancellation_reason of this DjStripePaymentIntent.  # noqa: E501
        :rtype: OneOfCancellationReasonEnumBlankEnum
        """
    ...
    def cancellation_reason(self, cancellation_reason):
        ...
        :type cancellation_reason: OneOfCancellationReasonEnumBlankEnum
        """
    ...
    def capture_method(self, capture_method):
        ...
        :type capture_method: CaptureMethodEnum
        """
    ...
    def confirmation_method(self, confirmation_method):
        ...
        :type confirmation_method: ConfirmationMethodEnum
        """
    ...
    def setup_future_usage(self):
        ...
        Indicates that you intend to make future payments with this PaymentIntent's payment method. If present, the payment method used with this PaymentIntent can be attached to a Customer, even after the transaction completes. Use `on_session` if you intend to only reuse the payment method when your customer is present in your checkout flow. Use `off_session` if your customer may or may not be in your checkout flow. Stripe uses `setup_future_usage` to dynamically optimize your payment flow and comply with regional legislation and network rules. For example, if your customer is impacted by SCA, using `off_session` will ensure that they are authenticated while processing this PaymentIntent. You will then be able to make later off-session payments for this customer.  # noqa: E501

        :return: The setup_future_usage of this DjStripePaymentIntent.  # noqa: E501
        :rtype: OneOfSetupFutureUsageEnumBlankEnumNullEnum
        """
    ...
    def setup_future_usage(self, setup_future_usage):
        ...
        :type setup_future_usage: OneOfSetupFutureUsageEnumBlankEnumNullEnum
        """
    ...
    def status(self):
        ...
        :rtype: DjStripePaymentIntentStatusEnum
        """
        return self._status
    ...
    def status(self, status):
        ...
        :type status: DjStripePaymentIntentStatusEnum
        """
