...
class PolymorphicEvent(object):
    ...
    def __init__(self, id=None, model=None, created_dt=None, source=None, event_name=None, payload=None, polymorphic_ctype=None, user=None, octoprint_server=None, device=None, data=None, stream=None, local_vars_configuration=None):  # noqa: E501
