...
class OctoPrintServer(object):
    ...
    def __init__(self, id=None, settings=None, octoprint_version=None, pip_version=None, python_version=None, printnanny_plugin_version=None, created_dt=None, updated_dt=None, user=None, pi=None, local_vars_configuration=None):  # noqa: E501
