...
T = TypeVar("T", bound="PatchedEmailAlertSettingsRequest")


@attr.s(auto_attribs=True)
class PatchedEmailAlertSettingsRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        patched_email_alert_settings_request = cls(
            progress_percent=progress_percent,
            enabled=enabled,
            event_types=event_types,
        )

        patched_email_alert_settings_request.additional_properties = d
        return patched_email_alert_settings_request
