...
class OctoPrintSettings(object):
    ...
    def __init__(self, id=None, octoprint_enabled=None, events_enabled=None, sync_gcode=None, sync_printer_profiles=None, sync_backups=None, auto_backup=None, updated_dt=None, octoprint_server=None, user=None, local_vars_configuration=None):  # noqa: E501
