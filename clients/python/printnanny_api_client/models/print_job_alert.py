...
class PrintJobAlert(object):
    ...
    def __init__(self, id=None, created_dt=None, event_type=None, event_source=None, payload=None, email_message_id=None, celery_task_id=None, image=None, user=None, pi=None, local_vars_configuration=None):  # noqa: E501
    ...
    def email_message_id(self, email_message_id):
        ...
        if (self.local_vars_configuration.client_side_validation and
                email_message_id is not None and len(email_message_id) > 255):
            raise ValueError("Invalid value for `email_message_id`, length must be less than or equal to `255`")  # noqa: E501
    ...
    def celery_task_id(self, celery_task_id):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                celery_task_id is not None and len(celery_task_id) > 255):
            raise ValueError("Invalid value for `celery_task_id`, length must be less than or equal to `255`")  # noqa: E501

        self._celery_task_id = celery_task_id

    @property
    def image(self):
        """Gets the image of this PrintJobAlert.  # noqa: E501


        :return: The image of this PrintJobAlert.  # noqa: E501
        :rtype: str
        """
        return self._image
    ...
    def image(self, image):
        """Sets the image of this PrintJobAlert.


        :param image: The image of this PrintJobAlert.  # noqa: E501
        :type image: str
        """
