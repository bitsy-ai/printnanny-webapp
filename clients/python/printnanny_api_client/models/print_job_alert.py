...
class PrintJobAlert(object):
    ...
    def __init__(self, id=None, created_dt=None, event_type=None, event_source=None, payload=None, email_message_id=None, image=None, user=None, pi=None, local_vars_configuration=None):  # noqa: E501
