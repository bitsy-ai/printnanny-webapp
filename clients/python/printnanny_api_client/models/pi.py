...
class Pi(object):
    ...
    def __init__(self, id=None, last_boot=None, network_settings=None, user=None, system_info=None, webrtc_edge=None, webrtc_cloud=None, latest_camera_snapshot_url=None, octoprint_server=None, hostname=None, favorite=None, sbc=None, setup_finished=None, nats_app=None, urls=None, shortname_urls=None, mdns_urls=None, created_dt=None, local_vars_configuration=None):  # noqa: E501
