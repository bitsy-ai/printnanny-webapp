...
class Pi(object):
    ...
    def __init__(self, id=None, last_boot=None, settings=None, user=None, system_info=None, public_key=None, webrtc_edge=None, webrtc_cloud=None, octoprint_server=None, urls=None, sbc=None, edition=None, created_dt=None, hostname=None, fqdn=None, favorite=None, setup_finished=None, local_vars_configuration=None):  # noqa: E501
