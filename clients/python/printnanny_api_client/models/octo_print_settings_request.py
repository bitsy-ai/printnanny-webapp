...
class OctoPrintSettingsRequest(object):
    ...
    def __init__(self, sync_gcode=None, sync_printer_profiles=None, sync_backups=None, monitoring_auto_start=None, monitoring_auto_pause=None, local_vars_configuration=None):  # noqa: E501
