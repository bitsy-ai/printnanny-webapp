...
T = TypeVar("T", bound="OctoPrintSettingsRequest")


@attr.s(auto_attribs=True)
class OctoPrintSettingsRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        octo_print_settings_request = cls(
            octoprint_server=octoprint_server,
        ...
        octo_print_settings_request.additional_properties = d
        return octo_print_settings_request
