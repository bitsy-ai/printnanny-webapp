...
class RegisterRequest(object):
    ...
    @property
    def username(self):
        """Gets the username of this RegisterRequest.  # noqa: E501


        :return: The username of this RegisterRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def username(self, username):
        ...
        if (self.local_vars_configuration.client_side_validation and
            ...
            raise ValueError("Invalid value for `username`, length must be less than or equal to `0`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
