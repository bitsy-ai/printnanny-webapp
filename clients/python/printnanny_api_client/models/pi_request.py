...
class PiRequest(object):
    ...
    def favorite(self, favorite):
        ...
        if (self.local_vars_configuration.client_side_validation and
                favorite is not None and len(favorite) < 1):
            raise ValueError("Invalid value for `favorite`, length must be greater than or equal to `1`")  # noqa: E501
    ...
    def sbc(self, sbc):
        ...
        if (self.local_vars_configuration.client_side_validation and
                sbc is not None and len(sbc) < 1):
            raise ValueError("Invalid value for `sbc`, length must be greater than or equal to `1`")  # noqa: E501
    ...
    def setup_finished(self, setup_finished):
        ...
        if (self.local_vars_configuration.client_side_validation and
                setup_finished is not None and len(setup_finished) < 1):
            raise ValueError("Invalid value for `setup_finished`, length must be greater than or equal to `1`")  # noqa: E501
