...
T = TypeVar("T", bound="CallbackTokenAuth")


@attr.s(auto_attribs=True)
class CallbackTokenAuth:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        callback_token_auth = cls(
            token=token,
            email=email,
            mobile=mobile,
        )

        callback_token_auth.additional_properties = d
        return callback_token_auth
