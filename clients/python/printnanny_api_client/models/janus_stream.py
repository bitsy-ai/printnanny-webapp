...
class JanusStream(object):
    ...
    def __init__(self, id=None, api_domain=None, api_port=None, api_url=None, admin_url=None, admin_port=None, rtp_domain=None, ws_url=None, ws_port=None, config_type=None, created_dt=None, updated_dt=None, active=None, stream_secret=None, stream_pin=None, api_token=None, admin_secret=None, rtp_port=None, device=None, local_vars_configuration=None):  # noqa: E501
