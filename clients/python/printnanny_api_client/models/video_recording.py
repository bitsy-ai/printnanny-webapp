...
class VideoRecording(object):
    ...
    def __init__(self, id=None, mp4_upload_url=None, mp4_size=None, recording_start=None, recording_end=None, recording_status=None, cloud_sync_start=None, cloud_sync_end=None, cloud_sync_status=None, gcode_file_name=None, mp4_file=None, user=None, local_vars_configuration=None):  # noqa: E501
