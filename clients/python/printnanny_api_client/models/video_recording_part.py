...
class VideoRecordingPart(object):
    ...
    def __init__(self, id=None, size=None, buffer_index=None, buffer_runningtime=None, file_name=None, mp4_file=None, sync_start=None, sync_end=None, video_recording=None, user=None, local_vars_configuration=None):  # noqa: E501
