...
T = TypeVar("T", bound="WebrtcStreamRequest")


@attr.s(auto_attribs=True)
class WebrtcStreamRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        webrtc_stream_request = cls(
            active=active,
            config_type=config_type,
        )

        webrtc_stream_request.additional_properties = d
        return webrtc_stream_request
