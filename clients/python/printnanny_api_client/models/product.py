...
class Product(object):
    ...
    def __init__(self, id=None, djstripe_product=None, prices=None, deleted=None, created_dt=None, updated_dt=None, sku=None, slug=None, unit_label=None, name=None, description=None, statement_descriptor=None, images=None, is_active=None, is_shippable=None, is_preorder=None, is_subscription=None, stripe_price_lookup_key=None, local_vars_configuration=None):  # noqa: E501
