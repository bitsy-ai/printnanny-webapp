...
if TYPE_CHECKING:
    from ..models.pi_software_update_payload_request import PiSoftwareUpdatePayloadRequest


T = TypeVar("T", bound="PiSoftwareUpdateCommandRequest")


@attr.s(auto_attribs=True)
class PiSoftwareUpdateCommandRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        payload = PiSoftwareUpdatePayloadRequest.from_dict(d.pop("payload"))
        ...
        pi_software_update_command_request = cls(
            payload=payload,
            subject_pattern=subject_pattern,
            version=version,
            event_type=event_type,
        ...
        pi_software_update_command_request.additional_properties = d
        return pi_software_update_command_request
