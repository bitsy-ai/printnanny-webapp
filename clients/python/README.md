...
*DevicesApi* | [**pi_settings_create**](docs/DevicesApi.md#pi_settings_create) | **POST** /api/pi-settings/ | 
*DevicesApi* | [**pi_settings_list**](docs/DevicesApi.md#pi_settings_list) | **GET** /api/pi-settings/ | 
*DevicesApi* | [**pi_settings_partial_update**](docs/DevicesApi.md#pi_settings_partial_update) | **PATCH** /api/pi-settings/{id}/ | 
*DevicesApi* | [**pi_settings_retrieve**](docs/DevicesApi.md#pi_settings_retrieve) | **GET** /api/pi-settings/{id}/ | 
*DevicesApi* | [**pi_settings_update**](docs/DevicesApi.md#pi_settings_update) | **PUT** /api/pi-settings/{id}/ | 
...
## Documentation For Models
 ...
 - [PreferredDnsEnum](docs/PreferredDnsEnum.md)
