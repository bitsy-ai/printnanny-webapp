...
*DevicesApi* | [**devices_licenses_activate_update**](docs/DevicesApi.md#devices_licenses_activate_update) | **PUT** /api/devices/{device_id}/licenses/{id}/activate/ | 
*DevicesApi* | [**devices_licenses_list**](docs/DevicesApi.md#devices_licenses_list) | **GET** /api/devices/{device_id}/licenses/ | 
...
*DevicesApi* | [**devices_system_tasks_create**](docs/DevicesApi.md#devices_system_tasks_create) | **POST** /api/devices/{device_id}/system-tasks/ | 
*DevicesApi* | [**devices_system_tasks_list**](docs/DevicesApi.md#devices_system_tasks_list) | **GET** /api/devices/{device_id}/system-tasks/ | 
*DevicesApi* | [**devices_system_tasks_retrieve**](docs/DevicesApi.md#devices_system_tasks_retrieve) | **GET** /api/devices/{device_id}/system-tasks/{id}/ | 
...
## Documentation For Models
 ...
 - [SystemTaskRequest](docs/SystemTaskRequest.md)
 - [SystemTaskStatus](docs/SystemTaskStatus.md)
 - [SystemTaskType](docs/SystemTaskType.md)
