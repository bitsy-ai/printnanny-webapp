...
*DevicesApi* | [**janus_stream_key_update_or_create**](docs/DevicesApi.md#janus_stream_key_update_or_create) | **POST** /api/devices/{device_id}/janus-streams/update-or-create/ | 
...
*JanusApi* | [**janus_stream_key_update_or_create**](docs/JanusApi.md#janus_stream_key_update_or_create) | **POST** /api/devices/{device_id}/janus-streams/update-or-create/ | 
