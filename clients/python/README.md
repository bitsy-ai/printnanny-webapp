...
*VideosApi* | [**video_recordings_update_or_create**](docs/VideosApi.md#video_recordings_update_or_create) | **POST** /api/video-parts/{id}/update-or-create/ | 
*VideosApi* | [**video_recordings_update_or_create2**](docs/VideosApi.md#video_recordings_update_or_create2) | **POST** /api/videos/{id}/update-or-create/ | 
