...
*AlertsApi* | [**defect_alert_create**](docs/AlertsApi.md#defect_alert_create) | **POST** /api/defect-alerts/{id}/create_defect_alerts/ | 
...
*RemoteControlApi* | [**defect_alert_create**](docs/RemoteControlApi.md#defect_alert_create) | **POST** /api/defect-alerts/{id}/create_defect_alerts/ | 
