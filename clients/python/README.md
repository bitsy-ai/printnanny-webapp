...
------------ | ------------- | ------------- | -------------
*AlertSettingsApi* | [**api_alert_settings_list**](docs/AlertSettingsApi.md#api_alert_settings_list) | **GET** /api/alert_settings/ | 
*AlertSettingsApi* | [**api_alert_settings_methods_retrieve**](docs/AlertSettingsApi.md#api_alert_settings_methods_retrieve) | **GET** /api/alert_settings/methods/ | 
*AlertSettingsApi* | [**api_alert_settings_partial_update**](docs/AlertSettingsApi.md#api_alert_settings_partial_update) | **PATCH** /api/alert_settings/{id}/ | 
*AlertSettingsApi* | [**api_alert_settings_retrieve**](docs/AlertSettingsApi.md#api_alert_settings_retrieve) | **GET** /api/alert_settings/{id}/ | 
*AlertSettingsApi* | [**api_alert_settings_update**](docs/AlertSettingsApi.md#api_alert_settings_update) | **PUT** /api/alert_settings/{id}/ | 
*AlertsApi* | [**alerts_seen**](docs/AlertsApi.md#alerts_seen) | **PATCH** /api/alerts/seen/ | 
*AlertsApi* | [**api_alerts_list**](docs/AlertsApi.md#api_alerts_list) | **GET** /api/alerts/ | 
*AlertsApi* | [**api_alerts_partial_update**](docs/AlertsApi.md#api_alerts_partial_update) | **PATCH** /api/alerts/{id}/ | 
*AlertsApi* | [**api_alerts_recent_retrieve**](docs/AlertsApi.md#api_alerts_recent_retrieve) | **GET** /api/alerts/recent/ | 
*AlertsApi* | [**api_alerts_retrieve**](docs/AlertsApi.md#api_alerts_retrieve) | **GET** /api/alerts/{id}/ | 
*AlertsApi* | [**api_alerts_unread_retrieve**](docs/AlertsApi.md#api_alerts_unread_retrieve) | **GET** /api/alerts/unread/ | 
*AlertsApi* | [**api_alerts_update**](docs/AlertsApi.md#api_alerts_update) | **PUT** /api/alerts/{id}/ | 
*AlertsApi* | [**api_print_session_alerts_list**](docs/AlertsApi.md#api_print_session_alerts_list) | **GET** /api/print-session-alerts/ | 
*AlertsApi* | [**api_print_session_alerts_retrieve**](docs/AlertsApi.md#api_print_session_alerts_retrieve) | **GET** /api/print-session-alerts/{id}/ | 
...
*ApiApi* | [**api_users_list**](docs/ApiApi.md#api_users_list) | **GET** /api/users/ | 
*ApiApi* | [**api_users_me_retrieve**](docs/ApiApi.md#api_users_me_retrieve) | **GET** /api/users/me/ | 
*ApiApi* | [**api_users_partial_update**](docs/ApiApi.md#api_users_partial_update) | **PATCH** /api/users/{id}/ | 
*ApiApi* | [**api_users_retrieve**](docs/ApiApi.md#api_users_retrieve) | **GET** /api/users/{id}/ | 
*ApiApi* | [**api_users_update**](docs/ApiApi.md#api_users_update) | **PUT** /api/users/{id}/ | 
*EventsApi* | [**api_octoprint_events_create**](docs/EventsApi.md#api_octoprint_events_create) | **POST** /api/octoprint-events/ | 
*EventsApi* | [**api_octoprint_events_list**](docs/EventsApi.md#api_octoprint_events_list) | **GET** /api/octoprint-events/ | 
*EventsApi* | [**api_octoprint_events_retrieve**](docs/EventsApi.md#api_octoprint_events_retrieve) | **GET** /api/octoprint-events/{id}/ | 
*EventsApi* | [**api_plugin_events_list**](docs/EventsApi.md#api_plugin_events_list) | **GET** /api/plugin-events/ | 
*EventsApi* | [**api_plugin_events_retrieve**](docs/EventsApi.md#api_plugin_events_retrieve) | **GET** /api/plugin-events/{id}/ | 
*EventsApi* | [**api_print_job_states_list**](docs/EventsApi.md#api_print_job_states_list) | **GET** /api/print-job-states/ | 
*EventsApi* | [**api_print_job_states_retrieve**](docs/EventsApi.md#api_print_job_states_retrieve) | **GET** /api/print-job-states/{id}/ | 
