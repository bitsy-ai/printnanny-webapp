...
*DevicesApi* | [**devices_janus_create**](docs/DevicesApi.md#devices_janus_create) | **POST** /api/devices/{device_id}/janus/ | 
*DevicesApi* | [**devices_janus_list**](docs/DevicesApi.md#devices_janus_list) | **GET** /api/devices/{device_id}/janus/ | 
*DevicesApi* | [**devices_janus_partial_update**](docs/DevicesApi.md#devices_janus_partial_update) | **PATCH** /api/devices/{device_id}/janus/{id}/ | 
*DevicesApi* | [**devices_janus_retrieve**](docs/DevicesApi.md#devices_janus_retrieve) | **GET** /api/devices/{device_id}/janus/{id}/ | 
*DevicesApi* | [**devices_janus_update**](docs/DevicesApi.md#devices_janus_update) | **PUT** /api/devices/{device_id}/janus/{id}/ | 
...
*DevicesApi* | [**devices_printnanny_events_create**](docs/DevicesApi.md#devices_printnanny_events_create) | **POST** /api/devices/{device_id}/printnanny-events/ | 
*DevicesApi* | [**devices_printnanny_events_list**](docs/DevicesApi.md#devices_printnanny_events_list) | **GET** /api/devices/{device_id}/printnanny-events/ | 
*DevicesApi* | [**devices_printnanny_events_retrieve**](docs/DevicesApi.md#devices_printnanny_events_retrieve) | **GET** /api/devices/{device_id}/printnanny-events/{id}/ | 
...
*DevicesApi* | [**janus_auth_update_or_create**](docs/DevicesApi.md#janus_auth_update_or_create) | **POST** /api/devices/{device_id}/janus/update-or-create/ | 
...
*EventsApi* | [**devices_printnanny_events_create**](docs/EventsApi.md#devices_printnanny_events_create) | **POST** /api/devices/{device_id}/printnanny-events/ | 
*EventsApi* | [**devices_printnanny_events_list**](docs/EventsApi.md#devices_printnanny_events_list) | **GET** /api/devices/{device_id}/printnanny-events/ | 
*EventsApi* | [**devices_printnanny_events_retrieve**](docs/EventsApi.md#devices_printnanny_events_retrieve) | **GET** /api/devices/{device_id}/printnanny-events/{id}/ | 
...
## Documentation For Models
 ...
 - [PatchedJanusAuthRequest](docs/PatchedJanusAuthRequest.md)
