...
from printnanny_api_client.models.print_nanny_license import PrintNannyLicense  # noqa: E501
from printnanny_api_client.rest import ApiException

class TestPrintNannyLicense(unittest.TestCase):
    """PrintNannyLicense unit test stubs"""
