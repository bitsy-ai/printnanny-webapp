    ...
    def make_instance(self, include_optional):
        ...
        if include_optional :
            return VideoRecordingRequest(
                ...
                finalize_start = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                finalize_end = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
