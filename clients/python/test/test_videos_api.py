...
class TestVideosApi(unittest.TestCase):
    ...
    def test_video_parts_partial_update(self):
        """Test case for video_parts_partial_update
    ...
    def test_video_parts_update(self):
        """Test case for video_parts_update

        """
        pass

    def test_video_recording_parts_update_or_create(self):
        """Test case for video_recording_parts_update_or_create
