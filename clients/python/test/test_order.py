...
from printnanny_api_client.models.order import Order  # noqa: E501
...
class TestOrder(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = printnanny_api_client.models.order.Order()  # noqa: E501
        if include_optional :
            return Order(
                created_dt = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                djstripe_checkout_session = None, 
                djstripe_customer = None, 
                djstripe_payment_intent = None, 
                email = '', 
                id = '', 
                is_shippable = True, 
                is_subscription = True, 
                last_status = printnanny_api_client.models.order_status.OrderStatus(
                    id = 56, 
                ...
                status_history = [
                    printnanny_api_client.models.order_status.OrderStatus(
                        id = 56, 
                        deleted = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        created_dt = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        status = 'checkout_session_created', 
                ...
                user = printnanny_api_client.models.user.User(
                    ...
                    is_beta_tester = True, 
                    member_badges = [
                        printnanny_api_client.models.member_badge.MemberBadge(
                            id = 56, 
                            created_dt = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                            updated_dt = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                            type = '', 
