...
from print_nanny_client.models.paginated_remote_command_event_list import PaginatedRemoteCommandEventList  # noqa: E501
...
class TestPaginatedRemoteCommandEventList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = print_nanny_client.models.paginated_remote_command_event_list.PaginatedRemoteCommandEventList()  # noqa: E501
        if include_optional :
            return PaginatedRemoteCommandEventList(
                ...
                results = [
                    print_nanny_client.models.remote_command_event.RemoteCommandEvent(
                        id = 56, 
                        ts = 1.337, 
