...
class TestDevicesApi(unittest.TestCase):
    ...
    def test_pi_settings_create(self):
        """Test case for pi_settings_create

        """
        pass

    def test_pi_settings_list(self):
        """Test case for pi_settings_list

        """
        pass

    def test_pi_settings_partial_update(self):
        """Test case for pi_settings_partial_update

        """
        pass

    def test_pi_settings_retrieve(self):
        """Test case for pi_settings_retrieve

        """
        pass

    def test_pi_settings_update(self):
        """Test case for pi_settings_update
