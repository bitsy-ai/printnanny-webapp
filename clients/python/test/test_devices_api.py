...
class TestDevicesApi(unittest.TestCase):
    ...
    def test_devices_janus_cloud_streams_partial_update(self):
        """Test case for devices_janus_cloud_streams_partial_update
    ...
    def test_devices_janus_edge_streams_partial_update(self):
        """Test case for devices_janus_edge_streams_partial_update
