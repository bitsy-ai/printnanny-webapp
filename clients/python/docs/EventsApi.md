...
# **commands_create**
> PolymorphicCommand commands_create(polymorphic_command_request=polymorphic_command_request)
...
with printnanny_api_client.ApiClient(configuration) as api_client:
    ...
    polymorphic_command_request = printnanny_api_client.PolymorphicCommandRequest() # PolymorphicCommandRequest |  (optional)

    try:
        api_response = api_instance.commands_create(polymorphic_command_request=polymorphic_command_request)
        pprint(api_response)
...
------------- | ------------- | ------------- | -------------
 **polymorphic_command_request** | [**PolymorphicCommandRequest**](PolymorphicCommandRequest.md)|  | [optional] 

### Return type

[**PolymorphicCommand**](PolymorphicCommand.md)
...
# **commands_list**
> PaginatedPolymorphicCommandList commands_list(page=page)
...
with printnanny_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling EventsApi->commands_list: %s\n" % e)
```
...
[**PaginatedPolymorphicCommandList**](PaginatedPolymorphicCommandList.md)
...
# **commands_retrieve**
> PolymorphicCommand commands_retrieve(id)
...
with printnanny_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling EventsApi->commands_retrieve: %s\n" % e)
```
