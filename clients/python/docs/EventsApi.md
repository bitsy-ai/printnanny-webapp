...
test_event_request = printnanny_api_client.TestEventRequest() # TestEventRequest | 
    ...
    try:
        ...
        print("Exception when calling EventsApi->devices_test_events_create: %s\n" % e)
```
...
page = 56 # int | A page number within the paginated result set. (optional)
    ...
    try:
        ...
        print("Exception when calling EventsApi->devices_test_events_list: %s\n" % e)
```
...
id = 56 # int | A unique integer value identifying this test event.
    ...
    try:
        ...
        print("Exception when calling EventsApi->devices_test_events_retrieve: %s\n" % e)
```
