...
[**devices_printnanny_events_create**](EventsApi.md#devices_printnanny_events_create) | **POST** /api/devices/{device_id}/printnanny-events/ | 
[**devices_printnanny_events_list**](EventsApi.md#devices_printnanny_events_list) | **GET** /api/devices/{device_id}/printnanny-events/ | 
[**devices_printnanny_events_retrieve**](EventsApi.md#devices_printnanny_events_retrieve) | **GET** /api/devices/{device_id}/printnanny-events/{id}/ | 
...
> PolymorphicEvent devices_printnanny_events_create(device_id)
...
with printnanny_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.devices_printnanny_events_create(device_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling EventsApi->devices_printnanny_events_create: %s\n" % e)
```
...
> devices_printnanny_events_list(device_id, page=page)
...
page = 56 # int | A page number within the paginated result set. (optional)
    ...
    try:
        api_instance.devices_printnanny_events_list(device_id, page=page)
    except ApiException as e:
        print("Exception when calling EventsApi->devices_printnanny_events_list: %s\n" % e)
```
...
with printnanny_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = printnanny_api_client.EventsApi(api_client)
    device_id = 56 # int | 
id = 56 # int | A unique integer value identifying this print nanny event.

    try:
        api_instance.devices_printnanny_events_retrieve(device_id, id)
    except ApiException as e:
        print("Exception when calling EventsApi->devices_printnanny_events_retrieve: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **device_id** | **int**|  | 
 **id** | **int**| A unique integer value identifying this print nanny event. | 
