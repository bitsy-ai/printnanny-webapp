...
------------- | ------------- | -------------
[**api_octoprint_events_create**](EventsApi.md#api_octoprint_events_create) | **POST** /api/octoprint-events/ | 
[**api_octoprint_events_list**](EventsApi.md#api_octoprint_events_list) | **GET** /api/octoprint-events/ | 
[**api_octoprint_events_retrieve**](EventsApi.md#api_octoprint_events_retrieve) | **GET** /api/octoprint-events/{id}/ | 
[**api_plugin_events_list**](EventsApi.md#api_plugin_events_list) | **GET** /api/plugin-events/ | 
[**api_plugin_events_retrieve**](EventsApi.md#api_plugin_events_retrieve) | **GET** /api/plugin-events/{id}/ | 
[**api_print_job_states_list**](EventsApi.md#api_print_job_states_list) | **GET** /api/print-job-states/ | 
[**api_print_job_states_retrieve**](EventsApi.md#api_print_job_states_retrieve) | **GET** /api/print-job-states/{id}/ | 
...
with print_nanny_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling EventsApi->api_octoprint_events_create: %s\n" % e)
```
...
with print_nanny_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling EventsApi->api_octoprint_events_list: %s\n" % e)
```
...
with print_nanny_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling EventsApi->api_octoprint_events_retrieve: %s\n" % e)
```
...
# **api_plugin_events_list**
> PaginatedPluginEventList api_plugin_events_list(page=page)
...
with print_nanny_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.api_plugin_events_list(page=page)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling EventsApi->api_plugin_events_list: %s\n" % e)
```
...
# **api_plugin_events_retrieve**
> PluginEvent api_plugin_events_retrieve(id)
...
with print_nanny_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.api_plugin_events_retrieve(id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling EventsApi->api_plugin_events_retrieve: %s\n" % e)
```
...
# **api_print_job_states_list**
> PaginatedPrintSessionStateList api_print_job_states_list(page=page)
...
with print_nanny_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.api_print_job_states_list(page=page)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling EventsApi->api_print_job_states_list: %s\n" % e)
```
...
# **api_print_job_states_retrieve**
> PrintSessionState api_print_job_states_retrieve(id)
...
with print_nanny_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.api_print_job_states_retrieve(id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling EventsApi->api_print_job_states_retrieve: %s\n" % e)
```
