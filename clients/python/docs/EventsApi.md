...
[**octoprint_core_events_enum_retrieve2**](EventsApi.md#octoprint_core_events_enum_retrieve2) | **GET** /api/plugin-events/enum/ | 
[**octoprint_core_events_enum_retrieve3**](EventsApi.md#octoprint_core_events_enum_retrieve3) | **GET** /api/print-job-states/enum/ | 
...
[**plugin_events_create**](EventsApi.md#plugin_events_create) | **POST** /api/plugin-events/ | 
...
[**print_job_states_create**](EventsApi.md#print_job_states_create) | **POST** /api/print-job-states/ | 
...
# **octoprint_core_events_enum_retrieve2**
> str octoprint_core_events_enum_retrieve2()
...
with print_nanny_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.octoprint_core_events_enum_retrieve2()
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling EventsApi->octoprint_core_events_enum_retrieve2: %s\n" % e)
```
...
# **octoprint_core_events_enum_retrieve3**
> str octoprint_core_events_enum_retrieve3()
...
with print_nanny_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.octoprint_core_events_enum_retrieve3()
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling EventsApi->octoprint_core_events_enum_retrieve3: %s\n" % e)
```
