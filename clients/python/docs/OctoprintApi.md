...
> OctoPrintInstall octoprint_install_update_or_create(octo_print_install_request)
...
with printnanny_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.octoprint_install_update_or_create(octo_print_install_request)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling OctoprintApi->octoprint_install_update_or_create: %s\n" % e)
```
...
> OctoPrintSettings octoprint_settings_update_or_create(octo_print_settings_request=octo_print_settings_request)
...
with printnanny_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.octoprint_settings_update_or_create(octo_print_settings_request=octo_print_settings_request)
        pprint(api_response)
    except ApiException as e:
