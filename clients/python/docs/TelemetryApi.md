...
[**print_status_events_list**](TelemetryApi.md#print_status_events_list) | **GET** /api/print-status-events/ | 
[**print_status_events_retrieve**](TelemetryApi.md#print_status_events_retrieve) | **GET** /api/print-status-events/{id}/ | 
...
# **print_status_events_list**
> PaginatedPrintStatusEventList print_status_events_list(page=page)
...
with print_nanny_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.print_status_events_list(page=page)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TelemetryApi->print_status_events_list: %s\n" % e)
```
...
# **print_status_events_retrieve**
> PrintStatusEvent print_status_events_retrieve(id)
...
with print_nanny_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.print_status_events_retrieve(id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TelemetryApi->print_status_events_retrieve: %s\n" % e)
```
