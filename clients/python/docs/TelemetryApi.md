...
[**telemetry_remote_command_events_list**](TelemetryApi.md#telemetry_remote_command_events_list) | **GET** /api/telemetry/remote-command-events/ | 
[**telemetry_remote_command_events_retrieve**](TelemetryApi.md#telemetry_remote_command_events_retrieve) | **GET** /api/telemetry/remote-command-events/{id}/ | 
...
with print_nanny_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.telemetry_list(page=page)
        pprint(api_response)
...
# **telemetry_octoprint_events_create**
> OctoPrintEvent telemetry_octoprint_events_create(octo_print_event_request)
...
with print_nanny_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.telemetry_octoprint_events_create(octo_print_event_request)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TelemetryApi->telemetry_octoprint_events_create: %s\n" % e)
```
...
# **telemetry_octoprint_events_list**
> PaginatedOctoPrintEventList telemetry_octoprint_events_list(page=page)
...
with print_nanny_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.telemetry_octoprint_events_list(page=page)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TelemetryApi->telemetry_octoprint_events_list: %s\n" % e)
```
...
# **telemetry_octoprint_events_retrieve**
> OctoPrintEvent telemetry_octoprint_events_retrieve(id)
...
with print_nanny_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.telemetry_octoprint_events_retrieve(id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TelemetryApi->telemetry_octoprint_events_retrieve: %s\n" % e)
```
...
# **telemetry_print_status_events_list**
> PaginatedPrintStatusEventList telemetry_print_status_events_list(page=page)
...
with print_nanny_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.telemetry_print_status_events_list(page=page)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TelemetryApi->telemetry_print_status_events_list: %s\n" % e)
```
...
# **telemetry_print_status_events_retrieve**
> PrintStatusEvent telemetry_print_status_events_retrieve(id)
...
with print_nanny_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = print_nanny_client.TelemetryApi(api_client)
    id = 56 # int | A unique integer value identifying this print status event.

    try:
        api_response = api_instance.telemetry_print_status_events_retrieve(id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TelemetryApi->telemetry_print_status_events_retrieve: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **int**| A unique integer value identifying this print status event. | 
...
# **telemetry_remote_command_events_list**
> PaginatedRemoteCommandEventList telemetry_remote_command_events_list(page=page)
...
with print_nanny_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.telemetry_remote_command_events_list(page=page)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TelemetryApi->telemetry_remote_command_events_list: %s\n" % e)
```
...
# **telemetry_remote_command_events_retrieve**
> RemoteCommandEvent telemetry_remote_command_events_retrieve(id)
...
with print_nanny_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.telemetry_remote_command_events_retrieve(id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TelemetryApi->telemetry_remote_command_events_retrieve: %s\n" % e)
```
