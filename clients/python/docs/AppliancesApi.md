...
> Appliance appliances_retrieve_hostname(hostname)
...
with print_nanny_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.appliances_retrieve_hostname(hostname)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling AppliancesApi->appliances_retrieve_hostname: %s\n" % e)
```
