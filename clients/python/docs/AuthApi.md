...
with print_nanny_client.ApiClient(configuration) as api_client:
    ...
    email_auth_request = print_nanny_client.EmailAuthRequest() # EmailAuthRequest | 

    try:
        api_response = api_instance.auth_email_create(email_auth_request)
        pprint(api_response)
...
with print_nanny_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = print_nanny_client.AuthApi(api_client)
    mobile_auth_request = print_nanny_client.MobileAuthRequest() # MobileAuthRequest | 

    try:
        api_response = api_instance.auth_mobile_create(mobile_auth_request)
        pprint(api_response)
    except ApiException as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **mobile_auth_request** | [**MobileAuthRequest**](MobileAuthRequest.md)|  | 
