...
> PaginatedProductList cloud_plans_retrieve(page=page)
...
with printnanny_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.cloud_plans_retrieve(page=page)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling ShopApi->cloud_plans_retrieve: %s\n" % e)
```
...
> Product shop_products_retrieve(sku)
...
with printnanny_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.shop_products_retrieve(sku)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling ShopApi->shop_products_retrieve: %s\n" % e)
```
