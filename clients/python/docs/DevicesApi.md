...
with printnanny_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DevicesApi->devices_printnanny_events_create: %s\n" % e)
```
...
page = 56 # int | A page number within the paginated result set. (optional)
    ...
    try:
        ...
        print("Exception when calling DevicesApi->devices_printnanny_events_list: %s\n" % e)
```
...
id = 56 # int | A unique integer value identifying this print nanny event.
    ...
    try:
        ...
        print("Exception when calling DevicesApi->devices_printnanny_events_retrieve: %s\n" % e)
```
