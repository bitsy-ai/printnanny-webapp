...
> Device octoprint_devices_partial_update(id, patched_device_request=patched_device_request)
...
patched_device_request = print_nanny_client.PatchedDeviceRequest() # PatchedDeviceRequest |  (optional)
    ...
    try:
        api_response = api_instance.octoprint_devices_partial_update(id, patched_device_request=patched_device_request)
        pprint(api_response)
    except ApiException as e:
...
> Device octoprint_devices_update(id, device_request)
...
device_request = print_nanny_client.DeviceRequest() # DeviceRequest | 
    ...
    try:
        api_response = api_instance.octoprint_devices_update(id, device_request)
        pprint(api_response)
    except ApiException as e:
