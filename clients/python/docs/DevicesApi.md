...
[**devices_test_events_create**](DevicesApi.md#devices_test_events_create) | **POST** /api/devices/{device_id}/test-events/ | 
[**devices_test_events_list**](DevicesApi.md#devices_test_events_list) | **GET** /api/devices/{device_id}/test-events/ | 
[**devices_test_events_retrieve**](DevicesApi.md#devices_test_events_retrieve) | **GET** /api/devices/{device_id}/test-events/{id}/ | 
...
> TestEvent devices_test_events_create(device_id, test_event_request)
...
with printnanny_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = printnanny_api_client.DevicesApi(api_client)
    device_id = 56 # int | 
test_event_request = printnanny_api_client.TestEventRequest() # TestEventRequest | 

    try:
        api_response = api_instance.devices_test_events_create(device_id, test_event_request)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DevicesApi->devices_test_events_create: %s\n" % e)
```
...
> PaginatedTestEventList devices_test_events_list(device_id, page=page)
...
page = 56 # int | A page number within the paginated result set. (optional)
    ...
    try:
        api_response = api_instance.devices_test_events_list(device_id, page=page)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DevicesApi->devices_test_events_list: %s\n" % e)
```
...
[**PaginatedTestEventList**](PaginatedTestEventList.md)
...
> TestEvent devices_test_events_retrieve(device_id, id)
...
with printnanny_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = printnanny_api_client.DevicesApi(api_client)
    device_id = 56 # int | 
id = 56 # int | A unique integer value identifying this test event.

    try:
        api_response = api_instance.devices_test_events_retrieve(device_id, id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DevicesApi->devices_test_events_retrieve: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **device_id** | **int**|  | 
 **id** | **int**| A unique integer value identifying this test event. | 
