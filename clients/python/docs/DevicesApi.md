...
janus_cloud_stream_request = printnanny_api_client.JanusCloudStreamRequest() # JanusCloudStreamRequest | 
    ...
    try:
        ...
        print("Exception when calling DevicesApi->devices_janus_cloud_stream_get_or_create: %s\n" % e)
```
...
[**JanusCloudStream**](JanusCloudStream.md)
...
janus_cloud_stream_request = printnanny_api_client.JanusCloudStreamRequest() # JanusCloudStreamRequest | 
    ...
    try:
        ...
        print("Exception when calling DevicesApi->devices_janus_cloud_streams_create: %s\n" % e)
```
...
> PaginatedJanusCloudStreamList devices_janus_cloud_streams_list(device_id, page=page)
...
page = 56 # int | A page number within the paginated result set. (optional)
    ...
    try:
        api_response = api_instance.devices_janus_cloud_streams_list(device_id, page=page)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DevicesApi->devices_janus_cloud_streams_list: %s\n" % e)
```
...
[**PaginatedJanusCloudStreamList**](PaginatedJanusCloudStreamList.md)
...
> JanusCloudStream devices_janus_cloud_streams_partial_update(device_id, id, patched_janus_cloud_stream_request=patched_janus_cloud_stream_request)
...
patched_janus_cloud_stream_request = printnanny_api_client.PatchedJanusCloudStreamRequest() # PatchedJanusCloudStreamRequest |  (optional)

    try:
        api_response = api_instance.devices_janus_cloud_streams_partial_update(device_id, id, patched_janus_cloud_stream_request=patched_janus_cloud_stream_request)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DevicesApi->devices_janus_cloud_streams_partial_update: %s\n" % e)
```
 ...
 **patched_janus_cloud_stream_request** | [**PatchedJanusCloudStreamRequest**](PatchedJanusCloudStreamRequest.md)|  | [optional] 
...
> JanusCloudStream devices_janus_cloud_streams_retrieve(device_id, id)
...
id = 56 # int | A unique integer value identifying this janus stream.
    ...
    try:
        api_response = api_instance.devices_janus_cloud_streams_retrieve(device_id, id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DevicesApi->devices_janus_cloud_streams_retrieve: %s\n" % e)
```
...
janus_cloud_stream_request = printnanny_api_client.JanusCloudStreamRequest() # JanusCloudStreamRequest | 
    ...
    try:
        ...
        print("Exception when calling DevicesApi->devices_janus_cloud_streams_update: %s\n" % e)
```
...
> JanusEdgeStream devices_janus_edge_stream_get_or_create(device_id, janus_edge_stream_request)
...
with printnanny_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = printnanny_api_client.DevicesApi(api_client)
    device_id = 56 # int | 
janus_edge_stream_request = printnanny_api_client.JanusEdgeStreamRequest() # JanusEdgeStreamRequest | 

    try:
        api_response = api_instance.devices_janus_edge_stream_get_or_create(device_id, janus_edge_stream_request)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DevicesApi->devices_janus_edge_stream_get_or_create: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **device_id** | **int**|  | 
 **janus_edge_stream_request** | [**JanusEdgeStreamRequest**](JanusEdgeStreamRequest.md)|  | 

### Return type

[**JanusEdgeStream**](JanusEdgeStream.md)
...
> JanusEdgeStream devices_janus_edge_streams_create(device_id, janus_edge_stream_request)
...
janus_edge_stream_request = printnanny_api_client.JanusEdgeStreamRequest() # JanusEdgeStreamRequest | 
    ...
    try:
        api_response = api_instance.devices_janus_edge_streams_create(device_id, janus_edge_stream_request)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DevicesApi->devices_janus_edge_streams_create: %s\n" % e)
```
...
> PaginatedJanusEdgeStreamList devices_janus_edge_streams_list(device_id, page=page)
...
page = 56 # int | A page number within the paginated result set. (optional)
    ...
    try:
        api_response = api_instance.devices_janus_edge_streams_list(device_id, page=page)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DevicesApi->devices_janus_edge_streams_list: %s\n" % e)
```
...
[**PaginatedJanusEdgeStreamList**](PaginatedJanusEdgeStreamList.md)
...
> JanusEdgeStream devices_janus_edge_streams_partial_update(device_id, id, patched_janus_edge_stream_request=patched_janus_edge_stream_request)
...
with printnanny_api_client.ApiClient(configuration) as api_client:
    ...
    device_id = 56 # int | 
id = 56 # int | A unique integer value identifying this janus stream.
patched_janus_edge_stream_request = printnanny_api_client.PatchedJanusEdgeStreamRequest() # PatchedJanusEdgeStreamRequest |  (optional)

    try:
        api_response = api_instance.devices_janus_edge_streams_partial_update(device_id, id, patched_janus_edge_stream_request=patched_janus_edge_stream_request)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DevicesApi->devices_janus_edge_streams_partial_update: %s\n" % e)
```
 ...
 **device_id** | **int**|  | 
 **id** | **int**| A unique integer value identifying this janus stream. | 
 **patched_janus_edge_stream_request** | [**PatchedJanusEdgeStreamRequest**](PatchedJanusEdgeStreamRequest.md)|  | [optional] 
...
> JanusEdgeStream devices_janus_edge_streams_retrieve(device_id, id)
...
id = 56 # int | A unique integer value identifying this janus stream.
    ...
    try:
        api_response = api_instance.devices_janus_edge_streams_retrieve(device_id, id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DevicesApi->devices_janus_edge_streams_retrieve: %s\n" % e)
```
...
> JanusEdgeStream devices_janus_edge_streams_update(device_id, id, janus_edge_stream_request)
...
janus_edge_stream_request = printnanny_api_client.JanusEdgeStreamRequest() # JanusEdgeStreamRequest | 
    ...
    try:
        api_response = api_instance.devices_janus_edge_streams_update(device_id, id, janus_edge_stream_request)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DevicesApi->devices_janus_edge_streams_update: %s\n" % e)
```
