...
> License devices_licenses_activate_update(device_id, id, license_request)
...
license_request = printnanny_api_client.LicenseRequest() # LicenseRequest | 
    ...
    try:
        api_response = api_instance.devices_licenses_activate_update(device_id, id, license_request)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DevicesApi->devices_licenses_activate_update: %s\n" % e)
```
...
> PaginatedLicenseList devices_licenses_list(device_id, page=page)
...
page = 56 # int | A page number within the paginated result set. (optional)
    ...
    try:
        api_response = api_instance.devices_licenses_list(device_id, page=page)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DevicesApi->devices_licenses_list: %s\n" % e)
```
