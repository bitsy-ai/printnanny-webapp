...
# **alerts_recent**
> AlertBulkResponse alerts_recent()
...
# **alerts_unread**
> AlertBulkResponse alerts_unread()
...
with print_nanny_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.alerts_unread()
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling AlertsApi->alerts_unread: %s\n" % e)
```
