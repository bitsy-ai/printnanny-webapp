...
[**defect_alert_trigger**](AlertsApi.md#defect_alert_trigger) | **POST** /api/octoprint-devices/{id}/trigger_defect_alert/ | 
...
defect_alert_request = print_nanny_client.DefectAlertRequest() # DefectAlertRequest | 
    ...
    try:
        ...
        print("Exception when calling AlertsApi->defect_alert_trigger: %s\n" % e)
```
