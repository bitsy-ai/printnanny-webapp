...
[**defect_alert_create2**](AlertsApi.md#defect_alert_create2) | **POST** /api/print-session-alerts/ | 
...
# **defect_alert_create2**
> PrintSessionAlert defect_alert_create2(create_defect_alert_request)
...
with print_nanny_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.defect_alert_create2(create_defect_alert_request)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling AlertsApi->defect_alert_create2: %s\n" % e)
```
...
> PaginatedDefectAlertList print_session_alerts_list(page=page)
...
> DefectAlert print_session_alerts_retrieve(id)
