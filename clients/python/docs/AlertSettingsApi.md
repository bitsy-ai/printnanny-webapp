# printnanny_api_client.AlertSettingsApi
...
> AlertSettings alert_settings_get_or_create_retrieve()
...
> AlertSettings alert_settings_partial_update(id, patched_alert_settings_request=patched_alert_settings_request)
...
patched_alert_settings_request = printnanny_api_client.PatchedAlertSettingsRequest() # PatchedAlertSettingsRequest |  (optional)

    try:
        api_response = api_instance.alert_settings_partial_update(id, patched_alert_settings_request=patched_alert_settings_request)
        pprint(api_response)
    except ApiException as e:
 ...
 **patched_alert_settings_request** | [**PatchedAlertSettingsRequest**](PatchedAlertSettingsRequest.md)|  | [optional] 
...
> AlertSettings alert_settings_update(id, alert_settings_request=alert_settings_request)
...
with printnanny_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = printnanny_api_client.AlertSettingsApi(api_client)
    id = 56 # int | A unique integer value identifying this alert settings.
alert_settings_request = printnanny_api_client.AlertSettingsRequest() # AlertSettingsRequest |  (optional)

    try:
        api_response = api_instance.alert_settings_update(id, alert_settings_request=alert_settings_request)
        pprint(api_response)
    except ApiException as e:
...
------------- | ------------- | ------------- | -------------
 **id** | **int**| A unique integer value identifying this alert settings. | 
 **alert_settings_request** | [**AlertSettingsRequest**](AlertSettingsRequest.md)|  | [optional] 
