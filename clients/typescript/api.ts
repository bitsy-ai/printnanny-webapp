...
export const VideosApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        videoRecordingsGetOrCreate: async (id?: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/video-recordings/get-or-create/`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const VideosApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async videoRecordingsGetOrCreate(id?: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VideoRecording>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.videoRecordingsGetOrCreate(id, recordingStart, recordingEnd, recordingStatus, cloudSyncStart, cloudSyncEnd, cloudSyncStatus, gcodeFileName, mp4File, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const VideosApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        videoRecordingsGetOrCreate(id?: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: any): AxiosPromise<VideoRecording> {
            return localVarFp.videoRecordingsGetOrCreate(id, recordingStart, recordingEnd, recordingStatus, cloudSyncStart, cloudSyncEnd, cloudSyncStatus, gcodeFileName, mp4File, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {number} [page] A page number within the paginated result set.
...
export interface VideosApiInterface {
     ...
     * @memberof VideosApiInterface
     */
    videoRecordingsGetOrCreate(id?: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: AxiosRequestConfig): AxiosPromise<VideoRecording>;
...
export class VideosApi extends BaseAPI implements VideosApiInterface {
     ...
     * @memberof VideosApi
     */
    public videoRecordingsGetOrCreate(id?: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: AxiosRequestConfig) {
        return VideosApiFp(this.configuration).videoRecordingsGetOrCreate(id, recordingStart, recordingEnd, recordingStatus, cloudSyncStart, cloudSyncEnd, cloudSyncStatus, gcodeFileName, mp4File, options).then((request) => request(this.axios, this.basePath));
    }
