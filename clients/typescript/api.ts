...
export const CrashReportsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        videoRecordingsCreate: async (startDt: string, name: string, endDt?: string, mjrRecording?: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            assertParamExists('videoRecordingsCreate', 'name', name)
        ...
        videoRecordingsUpdate: async (id: number, startDt: string, name: string, endDt?: string, mjrRecording?: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            // verify required parameter 'startDt' is not null or undefined
            assertParamExists('videoRecordingsUpdate', 'startDt', startDt)
            // verify required parameter 'name' is not null or undefined
            assertParamExists('videoRecordingsUpdate', 'name', name)
            const localVarPath = `/api/video-recordings/{id}/`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
...
export const VideoRecordingsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        videoRecordingsRetrieve: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
...
export const VideoRecordingsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async videoRecordingsRetrieve(id: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VideoRecording>> {
...
export const VideoRecordingsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        videoRecordingsRetrieve(id: number, options?: any): AxiosPromise<VideoRecording> {
...
export interface VideoRecordingsApiInterface {
     ...
     */
    videoRecordingsRetrieve(id: number, options?: AxiosRequestConfig): AxiosPromise<VideoRecording>;
...
export class VideoRecordingsApi extends BaseAPI implements VideoRecordingsApiInterface {
     ...
     */
    public videoRecordingsRetrieve(id: number, options?: AxiosRequestConfig) {
