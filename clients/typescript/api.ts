...
export const VideosApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        pisCameraSnapshotsCreate: async (piId: number, image: any, pi: number, id?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'piId' is not null or undefined
...
export const VideosApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async pisCameraSnapshotsCreate(piId: number, image: any, pi: number, id?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CameraSnapshot>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.pisCameraSnapshotsCreate(piId, image, pi, id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const VideosApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        pisCameraSnapshotsCreate(piId: number, image: any, pi: number, id?: string, options?: any): AxiosPromise<CameraSnapshot> {
            return localVarFp.pisCameraSnapshotsCreate(piId, image, pi, id, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {number} piId 
...
export interface VideosApiInterface {
     ...
     */
    pisCameraSnapshotsCreate(piId: number, image: any, pi: number, id?: string, options?: AxiosRequestConfig): AxiosPromise<CameraSnapshot>;
...
export class VideosApi extends BaseAPI implements VideosApiInterface {
     ...
     * @memberof VideosApi
     */
    public pisCameraSnapshotsCreate(piId: number, image: any, pi: number, id?: string, options?: AxiosRequestConfig) {
        return VideosApiFp(this.configuration).pisCameraSnapshotsCreate(piId, image, pi, id, options).then((request) => request(this.axios, this.basePath));
    }
