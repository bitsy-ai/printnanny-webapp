...
export const CrashReportsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        crashReportsCreate: async (email?: string, osVersion?: string, osLogs?: any, browserVersion?: string, browserLogs?: any, user?: number, pi?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const CrashReportsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async crashReportsCreate(email?: string, osVersion?: string, osLogs?: any, browserVersion?: string, browserLogs?: any, user?: number, pi?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CrashReport>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.crashReportsCreate(email, osVersion, osLogs, browserVersion, browserLogs, user, pi, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const CrashReportsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        crashReportsCreate(email?: string, osVersion?: string, osLogs?: any, browserVersion?: string, browserLogs?: any, user?: number, pi?: number, options?: any): AxiosPromise<CrashReport> {
            return localVarFp.crashReportsCreate(email, osVersion, osLogs, browserVersion, browserLogs, user, pi, options).then((request) => request(axios, basePath));
        },
    };
};
...
export interface CrashReportsApiInterface {
     ...
     */
    crashReportsCreate(email?: string, osVersion?: string, osLogs?: any, browserVersion?: string, browserLogs?: any, user?: number, pi?: number, options?: AxiosRequestConfig): AxiosPromise<CrashReport>;
...
export class CrashReportsApi extends BaseAPI implements CrashReportsApiInterface {
     ...
     */
    public crashReportsCreate(email?: string, osVersion?: string, osLogs?: any, browserVersion?: string, browserLogs?: any, user?: number, pi?: number, options?: AxiosRequestConfig) {
        return CrashReportsApiFp(this.configuration).crashReportsCreate(email, osVersion, osLogs, browserVersion, browserLogs, user, pi, options).then((request) => request(this.axios, this.basePath));
    }
}
