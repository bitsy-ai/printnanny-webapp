...
export const CloudSyncStatusEnum = {
    Pending: 'pending',
    Inprogress: 'inprogress',
    Done: 'done'
} as const;

export type CloudSyncStatusEnum = typeof CloudSyncStatusEnum[keyof typeof CloudSyncStatusEnum];
...
export interface VideoRecording {
     ...
     * @memberof VideoRecording
     */
    'cloud_sync_start'?: string | null;
    /**
     * 
     * @type {string}
     * @memberof VideoRecording
     */
    'cloud_sync_end'?: string | null;
    /**
     * 
     * @type {CloudSyncStatusEnum}
     * @memberof VideoRecording
     */
...
export const VideosApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} [recordingEnd] 
         * @param {RecordingStatusEnum} [recordingStatus] 
         * @param {string} [cloudSyncStart] 
         * @param {string} [cloudSyncEnd] 
         * @param {CloudSyncStatusEnum} [cloudSyncStatus] 
         * @param {string} [gcodeFileName] 
         * @param {any} [mp4File] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        videoRecordingsCreate: async (id?: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/video-recordings/`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            if (recordingStart !== undefined) { 
                localVarFormParams.append('recording_start', recordingStart as any);
            }
    
            if (recordingEnd !== undefined) { 
                localVarFormParams.append('recording_end', recordingEnd as any);
            }
    
            if (recordingStatus !== undefined) { 
                localVarFormParams.append('recording_status', new Blob([JSON.stringify(recordingStatus)], { type: "application/json", }));
            }
    
            if (cloudSyncStart !== undefined) { 
                localVarFormParams.append('cloud_sync_start', cloudSyncStart as any);
            }
    
            if (cloudSyncEnd !== undefined) { 
                localVarFormParams.append('cloud_sync_end', cloudSyncEnd as any);
            }
    
            if (cloudSyncStatus !== undefined) { 
                localVarFormParams.append('cloud_sync_status', new Blob([JSON.stringify(cloudSyncStatus)], { type: "application/json", }));
            }
    
            if (gcodeFileName !== undefined) { 
                localVarFormParams.append('gcode_file_name', gcodeFileName as any);
            }
         ...
         * @throws {RequiredError}
         */
        videoRecordingsList: async (page?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/video-recordings/`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        videoRecordingsPartialUpdate: async (id: string, id2?: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        videoRecordingsRetrieve: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('videoRecordingsRetrieve', 'id', id)
            const localVarPath = `/api/video-recordings/{id}/`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @throws {RequiredError}
         */
        videoRecordingsUpdate: async (id: string, id2?: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        videoRecordingsUpdateOrCreate: async (id?: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/video-recordings/update-or-create/`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const VideosApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async videoRecordingsCreate(id?: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VideoRecording>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.videoRecordingsCreate(id, recordingStart, recordingEnd, recordingStatus, cloudSyncStart, cloudSyncEnd, cloudSyncStatus, gcodeFileName, mp4File, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async videoRecordingsList(page?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginatedVideoRecordingList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.videoRecordingsList(page, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async videoRecordingsPartialUpdate(id: string, id2?: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VideoRecording>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.videoRecordingsPartialUpdate(id, id2, recordingStart, recordingEnd, recordingStatus, cloudSyncStart, cloudSyncEnd, cloudSyncStatus, gcodeFileName, mp4File, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async videoRecordingsRetrieve(id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VideoRecording>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.videoRecordingsRetrieve(id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async videoRecordingsUpdate(id: string, id2?: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VideoRecording>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.videoRecordingsUpdate(id, id2, recordingStart, recordingEnd, recordingStatus, cloudSyncStart, cloudSyncEnd, cloudSyncStatus, gcodeFileName, mp4File, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async videoRecordingsUpdateOrCreate(id?: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VideoRecording>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.videoRecordingsUpdateOrCreate(id, recordingStart, recordingEnd, recordingStatus, cloudSyncStart, cloudSyncEnd, cloudSyncStatus, gcodeFileName, mp4File, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const VideosApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        videoRecordingsCreate(id?: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: any): AxiosPromise<VideoRecording> {
            return localVarFp.videoRecordingsCreate(id, recordingStart, recordingEnd, recordingStatus, cloudSyncStart, cloudSyncEnd, cloudSyncStatus, gcodeFileName, mp4File, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {number} [page] A page number within the paginated result set.
         ...
         * @throws {RequiredError}
         */
        videoRecordingsList(page?: number, options?: any): AxiosPromise<PaginatedVideoRecordingList> {
            return localVarFp.videoRecordingsList(page, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} id A UUID string identifying this video recording.
         ...
         * @throws {RequiredError}
         */
        videoRecordingsPartialUpdate(id: string, id2?: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: any): AxiosPromise<VideoRecording> {
            return localVarFp.videoRecordingsPartialUpdate(id, id2, recordingStart, recordingEnd, recordingStatus, cloudSyncStart, cloudSyncEnd, cloudSyncStatus, gcodeFileName, mp4File, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} id A UUID string identifying this video recording.
         ...
         * @throws {RequiredError}
         */
        videoRecordingsRetrieve(id: string, options?: any): AxiosPromise<VideoRecording> {
            return localVarFp.videoRecordingsRetrieve(id, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} id A UUID string identifying this video recording.
         ...
         * @throws {RequiredError}
         */
        videoRecordingsUpdate(id: string, id2?: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: any): AxiosPromise<VideoRecording> {
            return localVarFp.videoRecordingsUpdate(id, id2, recordingStart, recordingEnd, recordingStatus, cloudSyncStart, cloudSyncEnd, cloudSyncStatus, gcodeFileName, mp4File, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} [id] 
         ...
         * @throws {RequiredError}
         */
        videoRecordingsUpdateOrCreate(id?: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: any): AxiosPromise<VideoRecording> {
            return localVarFp.videoRecordingsUpdateOrCreate(id, recordingStart, recordingEnd, recordingStatus, cloudSyncStart, cloudSyncEnd, cloudSyncStatus, gcodeFileName, mp4File, options).then((request) => request(axios, basePath));
        },
    };
};
...
export interface VideosApiInterface {
     ...
     */
    videoRecordingsCreate(id?: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: AxiosRequestConfig): AxiosPromise<VideoRecording>;
     ...
     * @memberof VideosApiInterface
     */
    videoRecordingsList(page?: number, options?: AxiosRequestConfig): AxiosPromise<PaginatedVideoRecordingList>;
     ...
     * @memberof VideosApiInterface
     */
    videoRecordingsPartialUpdate(id: string, id2?: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: AxiosRequestConfig): AxiosPromise<VideoRecording>;
     ...
     * @memberof VideosApiInterface
     */
    videoRecordingsRetrieve(id: string, options?: AxiosRequestConfig): AxiosPromise<VideoRecording>;
     ...
     * @memberof VideosApiInterface
     */
    videoRecordingsUpdate(id: string, id2?: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: AxiosRequestConfig): AxiosPromise<VideoRecording>;
     ...
     * @memberof VideosApiInterface
     */
    videoRecordingsUpdateOrCreate(id?: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: AxiosRequestConfig): AxiosPromise<VideoRecording>;
...
export class VideosApi extends BaseAPI implements VideosApiInterface {
     ...
     * @memberof VideosApi
     */
    public videoRecordingsCreate(id?: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: AxiosRequestConfig) {
        return VideosApiFp(this.configuration).videoRecordingsCreate(id, recordingStart, recordingEnd, recordingStatus, cloudSyncStart, cloudSyncEnd, cloudSyncStatus, gcodeFileName, mp4File, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof VideosApi
     */
    public videoRecordingsList(page?: number, options?: AxiosRequestConfig) {
        return VideosApiFp(this.configuration).videoRecordingsList(page, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof VideosApi
     */
    public videoRecordingsPartialUpdate(id: string, id2?: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: AxiosRequestConfig) {
        return VideosApiFp(this.configuration).videoRecordingsPartialUpdate(id, id2, recordingStart, recordingEnd, recordingStatus, cloudSyncStart, cloudSyncEnd, cloudSyncStatus, gcodeFileName, mp4File, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof VideosApi
     */
    public videoRecordingsRetrieve(id: string, options?: AxiosRequestConfig) {
        return VideosApiFp(this.configuration).videoRecordingsRetrieve(id, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof VideosApi
     */
    public videoRecordingsUpdate(id: string, id2?: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: AxiosRequestConfig) {
        return VideosApiFp(this.configuration).videoRecordingsUpdate(id, id2, recordingStart, recordingEnd, recordingStatus, cloudSyncStart, cloudSyncEnd, cloudSyncStatus, gcodeFileName, mp4File, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof VideosApi
     */
    public videoRecordingsUpdateOrCreate(id?: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: AxiosRequestConfig) {
        return VideosApiFp(this.configuration).videoRecordingsUpdateOrCreate(id, recordingStart, recordingEnd, recordingStatus, cloudSyncStart, cloudSyncEnd, cloudSyncStatus, gcodeFileName, mp4File, options).then((request) => request(this.axios, this.basePath));
    }
}
