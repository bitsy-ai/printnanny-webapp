...
export const CrashReportsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        videoRecordingsCreate: async (recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        videoRecordingsPartialUpdate: async (id: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        videoRecordingsUpdate: async (id: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
...
export const CrashReportsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async videoRecordingsCreate(recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VideoRecording>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.videoRecordingsCreate(recordingStart, recordingEnd, recordingStatus, cloudSyncStart, cloudSyncEnd, cloudSyncStatus, gcodeFileName, mp4File, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async videoRecordingsPartialUpdate(id: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VideoRecording>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.videoRecordingsPartialUpdate(id, recordingStart, recordingEnd, recordingStatus, cloudSyncStart, cloudSyncEnd, cloudSyncStatus, gcodeFileName, mp4File, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async videoRecordingsUpdate(id: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VideoRecording>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.videoRecordingsUpdate(id, recordingStart, recordingEnd, recordingStatus, cloudSyncStart, cloudSyncEnd, cloudSyncStatus, gcodeFileName, mp4File, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const CrashReportsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        videoRecordingsCreate(recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: any): AxiosPromise<VideoRecording> {
            return localVarFp.videoRecordingsCreate(recordingStart, recordingEnd, recordingStatus, cloudSyncStart, cloudSyncEnd, cloudSyncStatus, gcodeFileName, mp4File, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {number} [page] A page number within the paginated result set.
         ...
         * @throws {RequiredError}
         */
        videoRecordingsPartialUpdate(id: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: any): AxiosPromise<VideoRecording> {
            return localVarFp.videoRecordingsPartialUpdate(id, recordingStart, recordingEnd, recordingStatus, cloudSyncStart, cloudSyncEnd, cloudSyncStatus, gcodeFileName, mp4File, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} id A UUID string identifying this video recording.
         ...
         * @throws {RequiredError}
         */
        videoRecordingsUpdate(id: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: any): AxiosPromise<VideoRecording> {
            return localVarFp.videoRecordingsUpdate(id, recordingStart, recordingEnd, recordingStatus, cloudSyncStart, cloudSyncEnd, cloudSyncStatus, gcodeFileName, mp4File, options).then((request) => request(axios, basePath));
        },
    };
};
...
export interface CrashReportsApiInterface {
     ...
     * @memberof CrashReportsApiInterface
     */
    videoRecordingsCreate(recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: AxiosRequestConfig): AxiosPromise<VideoRecording>;
     ...
     * @memberof CrashReportsApiInterface
     */
    videoRecordingsPartialUpdate(id: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: AxiosRequestConfig): AxiosPromise<VideoRecording>;
     ...
     * @memberof CrashReportsApiInterface
     */
    videoRecordingsUpdate(id: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: AxiosRequestConfig): AxiosPromise<VideoRecording>;
...
export class CrashReportsApi extends BaseAPI implements CrashReportsApiInterface {
     ...
     * @memberof CrashReportsApi
     */
    public videoRecordingsCreate(recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: AxiosRequestConfig) {
        return CrashReportsApiFp(this.configuration).videoRecordingsCreate(recordingStart, recordingEnd, recordingStatus, cloudSyncStart, cloudSyncEnd, cloudSyncStatus, gcodeFileName, mp4File, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public videoRecordingsList(page?: number, options?: AxiosRequestConfig) {
        return CrashReportsApiFp(this.configuration).videoRecordingsList(page, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CrashReportsApi
     */
    public videoRecordingsPartialUpdate(id: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: AxiosRequestConfig) {
        return CrashReportsApiFp(this.configuration).videoRecordingsPartialUpdate(id, recordingStart, recordingEnd, recordingStatus, cloudSyncStart, cloudSyncEnd, cloudSyncStatus, gcodeFileName, mp4File, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CrashReportsApi
     */
    public videoRecordingsUpdate(id: string, recordingStart?: string, recordingEnd?: string, recordingStatus?: RecordingStatusEnum, cloudSyncStart?: string, cloudSyncEnd?: string, cloudSyncStatus?: CloudSyncStatusEnum, gcodeFileName?: string, mp4File?: any, options?: AxiosRequestConfig) {
        return CrashReportsApiFp(this.configuration).videoRecordingsUpdate(id, recordingStart, recordingEnd, recordingStatus, cloudSyncStart, cloudSyncEnd, cloudSyncStatus, gcodeFileName, mp4File, options).then((request) => request(this.axios, this.basePath));
    }
}
...
/**
 * VideoRecordingsApi - axios parameter creator
 * @export
 */
export const VideoRecordingsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
         * @param {string} id A UUID string identifying this video recording.
...
/**
 * VideoRecordingsApi - functional programming interface
 * @export
 */
export const VideoRecordingsApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = VideoRecordingsApiAxiosParamCreator(configuration)
    return {
        /**
         * 
         * @param {string} id A UUID string identifying this video recording.
...
/**
 * VideoRecordingsApi - factory interface
 * @export
 */
export const VideoRecordingsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = VideoRecordingsApiFp(configuration)
    return {
        /**
         * 
         * @param {string} id A UUID string identifying this video recording.
...
/**
 * VideoRecordingsApi - interface
 * @export
 * @interface VideoRecordingsApi
 */
export interface VideoRecordingsApiInterface {
    /**
     * 
     * @param {string} id A UUID string identifying this video recording.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof VideoRecordingsApiInterface
     */
...
/**
 * VideoRecordingsApi - object-oriented interface
 * @export
 * @class VideoRecordingsApi
 * @extends {BaseAPI}
 */
export class VideoRecordingsApi extends BaseAPI implements VideoRecordingsApiInterface {
    /**
     * 
     * @param {string} id A UUID string identifying this video recording.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof VideoRecordingsApi
     */
    public videoRecordingsRetrieve(id: string, options?: AxiosRequestConfig) {
        return VideoRecordingsApiFp(this.configuration).videoRecordingsRetrieve(id, options).then((request) => request(this.axios, this.basePath));
    }
}
