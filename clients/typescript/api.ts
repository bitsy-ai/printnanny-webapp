 ...
 * 
 * @export
 * @interface OrderCheckoutRequestRequest
 */
export interface OrderCheckoutRequestRequest {
    /**
     * 
     * @type {Array<OrderItemRequest>}
     * @memberof OrderCheckoutRequestRequest
     */
...
export const ShopApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * 
         * @param {OrderCheckoutRequestRequest} orderCheckoutRequestRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        shopOrdersCreate: async (orderCheckoutRequestRequest: OrderCheckoutRequestRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'orderCheckoutRequestRequest' is not null or undefined
            assertParamExists('shopOrdersCreate', 'orderCheckoutRequestRequest', orderCheckoutRequestRequest)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(orderCheckoutRequestRequest, localVarRequestOptions, configuration)
...
export const ShopApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async shopOrdersCreate(orderCheckoutRequestRequest: OrderCheckoutRequestRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Order>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.shopOrdersCreate(orderCheckoutRequestRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const ShopApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        shopOrdersCreate(orderCheckoutRequestRequest: OrderCheckoutRequestRequest, options?: any): AxiosPromise<Order> {
            return localVarFp.shopOrdersCreate(orderCheckoutRequestRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {number} [page] A page number within the paginated result set.
...
export interface ShopApiInterface {
     ...
     * @memberof ShopApiInterface
     */
    shopOrdersCreate(orderCheckoutRequestRequest: OrderCheckoutRequestRequest, options?: AxiosRequestConfig): AxiosPromise<Order>;
...
export class ShopApi extends BaseAPI implements ShopApiInterface {
     ...
     * @memberof ShopApi
     */
    public shopOrdersCreate(orderCheckoutRequestRequest: OrderCheckoutRequestRequest, options?: AxiosRequestConfig) {
        return ShopApiFp(this.configuration).shopOrdersCreate(orderCheckoutRequestRequest, options).then((request) => request(this.axios, this.basePath));
    }
