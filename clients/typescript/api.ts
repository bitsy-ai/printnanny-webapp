 ...
 * 
 * @export
 * @interface PatchedVideoRecordingPartRequest
 */
export interface PatchedVideoRecordingPartRequest {
    /**
     * 
     * @type {string}
     * @memberof PatchedVideoRecordingPartRequest
     */
    'id'?: string;
    /**
     * 
 ...
 * 
 * @export
 * @interface VideoRecordingPartRequest
 */
export interface VideoRecordingPartRequest {
    /**
     * 
     * @type {string}
     * @memberof VideoRecordingPartRequest
     */
    'id': string;
    /**
     * 
...
export const VideosApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
         * @param {VideoRecordingPartRequest} videoRecordingPartRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        videoPartsCreate: async (videoRecordingPartRequest: VideoRecordingPartRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'videoRecordingPartRequest' is not null or undefined
            assertParamExists('videoPartsCreate', 'videoRecordingPartRequest', videoRecordingPartRequest)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(videoRecordingPartRequest, localVarRequestOptions, configuration)
         ...
         * @param {PatchedVideoRecordingPartRequest} [patchedVideoRecordingPartRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        videoPartsPartialUpdate: async (id: string, patchedVideoRecordingPartRequest?: PatchedVideoRecordingPartRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('videoPartsPartialUpdate', 'id', id)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(patchedVideoRecordingPartRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        videoPartsUpdate: async (id: string, videoRecordingPartRequest: VideoRecordingPartRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('videoPartsUpdate', 'id', id)
            // verify required parameter 'videoRecordingPartRequest' is not null or undefined
            assertParamExists('videoPartsUpdate', 'videoRecordingPartRequest', videoRecordingPartRequest)
            const localVarPath = `/api/video-parts/{id}/`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @throws {RequiredError}
         */
        videoRecordingPartsUpdateOrCreate: async (videoRecordingPartRequest: VideoRecordingPartRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'videoRecordingPartRequest' is not null or undefined
            assertParamExists('videoRecordingPartsUpdateOrCreate', 'videoRecordingPartRequest', videoRecordingPartRequest)
            const localVarPath = `/api/video-parts/update-or-create/`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const VideosApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async videoPartsCreate(videoRecordingPartRequest: VideoRecordingPartRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VideoRecordingPart>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.videoPartsCreate(videoRecordingPartRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async videoPartsPartialUpdate(id: string, patchedVideoRecordingPartRequest?: PatchedVideoRecordingPartRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VideoRecordingPart>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.videoPartsPartialUpdate(id, patchedVideoRecordingPartRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async videoPartsUpdate(id: string, videoRecordingPartRequest: VideoRecordingPartRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VideoRecordingPart>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.videoPartsUpdate(id, videoRecordingPartRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async videoRecordingPartsUpdateOrCreate(videoRecordingPartRequest: VideoRecordingPartRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VideoRecordingPart>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.videoRecordingPartsUpdateOrCreate(videoRecordingPartRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const VideosApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        videoPartsCreate(videoRecordingPartRequest: VideoRecordingPartRequest, options?: any): AxiosPromise<VideoRecordingPart> {
            return localVarFp.videoPartsCreate(videoRecordingPartRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {number} [page] A page number within the paginated result set.
         ...
         * @throws {RequiredError}
         */
        videoPartsPartialUpdate(id: string, patchedVideoRecordingPartRequest?: PatchedVideoRecordingPartRequest, options?: any): AxiosPromise<VideoRecordingPart> {
            return localVarFp.videoPartsPartialUpdate(id, patchedVideoRecordingPartRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} id A unique value identifying this video recording part.
         ...
         * @throws {RequiredError}
         */
        videoPartsUpdate(id: string, videoRecordingPartRequest: VideoRecordingPartRequest, options?: any): AxiosPromise<VideoRecordingPart> {
            return localVarFp.videoPartsUpdate(id, videoRecordingPartRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {VideoRecordingPartRequest} videoRecordingPartRequest 
         ...
         * @throws {RequiredError}
         */
        videoRecordingPartsUpdateOrCreate(videoRecordingPartRequest: VideoRecordingPartRequest, options?: any): AxiosPromise<VideoRecordingPart> {
            return localVarFp.videoRecordingPartsUpdateOrCreate(videoRecordingPartRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} id A UUID string identifying this video recording.
...
export interface VideosApiInterface {
     ...
     */
    videoPartsCreate(videoRecordingPartRequest: VideoRecordingPartRequest, options?: AxiosRequestConfig): AxiosPromise<VideoRecordingPart>;
     ...
     * @memberof VideosApiInterface
     */
    videoPartsPartialUpdate(id: string, patchedVideoRecordingPartRequest?: PatchedVideoRecordingPartRequest, options?: AxiosRequestConfig): AxiosPromise<VideoRecordingPart>;
     ...
     * @memberof VideosApiInterface
     */
    videoPartsUpdate(id: string, videoRecordingPartRequest: VideoRecordingPartRequest, options?: AxiosRequestConfig): AxiosPromise<VideoRecordingPart>;
     ...
     * @memberof VideosApiInterface
     */
    videoRecordingPartsUpdateOrCreate(videoRecordingPartRequest: VideoRecordingPartRequest, options?: AxiosRequestConfig): AxiosPromise<VideoRecordingPart>;
...
export class VideosApi extends BaseAPI implements VideosApiInterface {
     ...
     * @memberof VideosApi
     */
    public videoPartsCreate(videoRecordingPartRequest: VideoRecordingPartRequest, options?: AxiosRequestConfig) {
        return VideosApiFp(this.configuration).videoPartsCreate(videoRecordingPartRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof VideosApi
     */
    public videoPartsPartialUpdate(id: string, patchedVideoRecordingPartRequest?: PatchedVideoRecordingPartRequest, options?: AxiosRequestConfig) {
        return VideosApiFp(this.configuration).videoPartsPartialUpdate(id, patchedVideoRecordingPartRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof VideosApi
     */
    public videoPartsUpdate(id: string, videoRecordingPartRequest: VideoRecordingPartRequest, options?: AxiosRequestConfig) {
        return VideosApiFp(this.configuration).videoPartsUpdate(id, videoRecordingPartRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof VideosApi
     */
    public videoRecordingPartsUpdateOrCreate(videoRecordingPartRequest: VideoRecordingPartRequest, options?: AxiosRequestConfig) {
        return VideosApiFp(this.configuration).videoRecordingPartsUpdateOrCreate(videoRecordingPartRequest, options).then((request) => request(this.axios, this.basePath));
    }
