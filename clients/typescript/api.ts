...
export const VideosApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        videoPartsCreate: async (id: string, size: number, bufferIndex: number, bufferRunningtime: number, fileName: string, videoRecording: string, mp4File?: any, syncStart?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
...
export const VideosApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async videoPartsCreate(id: string, size: number, bufferIndex: number, bufferRunningtime: number, fileName: string, videoRecording: string, mp4File?: any, syncStart?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VideoRecordingPart>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.videoPartsCreate(id, size, bufferIndex, bufferRunningtime, fileName, videoRecording, mp4File, syncStart, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const VideosApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        videoPartsCreate(id: string, size: number, bufferIndex: number, bufferRunningtime: number, fileName: string, videoRecording: string, mp4File?: any, syncStart?: string, options?: any): AxiosPromise<VideoRecordingPart> {
            return localVarFp.videoPartsCreate(id, size, bufferIndex, bufferRunningtime, fileName, videoRecording, mp4File, syncStart, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {number} [page] A page number within the paginated result set.
...
export interface VideosApiInterface {
     ...
     */
    videoPartsCreate(id: string, size: number, bufferIndex: number, bufferRunningtime: number, fileName: string, videoRecording: string, mp4File?: any, syncStart?: string, options?: AxiosRequestConfig): AxiosPromise<VideoRecordingPart>;
...
export class VideosApi extends BaseAPI implements VideosApiInterface {
     ...
     * @memberof VideosApi
     */
    public videoPartsCreate(id: string, size: number, bufferIndex: number, bufferRunningtime: number, fileName: string, videoRecording: string, mp4File?: any, syncStart?: string, options?: AxiosRequestConfig) {
        return VideosApiFp(this.configuration).videoPartsCreate(id, size, bufferIndex, bufferRunningtime, fileName, videoRecording, mp4File, syncStart, options).then((request) => request(this.axios, this.basePath));
    }
