...
enum class PrintJobStatusEnum(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: Any?): kotlin.String? = if (data is PrintJobStatusEnum) "$data" else null

        /**
         * Returns a valid [PrintJobStatusEnum] for [data], null otherwise.
         */
        fun decode(data: Any?): PrintJobStatusEnum? = data?.let {
