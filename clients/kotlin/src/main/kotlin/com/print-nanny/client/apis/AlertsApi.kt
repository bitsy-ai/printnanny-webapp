...
class AlertsApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun alertsList(page: kotlin.Int?) : PaginatedAlertList {
        ...
        val localVarResponse = request<Unit, PaginatedAlertList>(
            localVariableConfig
        )
    ...
    */
    fun alertsListRequestConfig(page: kotlin.Int?) : RequestConfig<Unit> {
    ...
    */
    ...
    fun alertsPartialUpdate(id: kotlin.Int, patchedAlertRequest: PatchedAlertRequest?) : Alert {
        ...
        val localVarResponse = request<PatchedAlertRequest, Alert>(
            localVariableConfig
        )
    ...
    * @return RequestConfig
    */
    fun alertsPartialUpdateRequestConfig(id: kotlin.Int, patchedAlertRequest: PatchedAlertRequest?) : RequestConfig<PatchedAlertRequest> {
        val localVariableBody = patchedAlertRequest
    ...
    */
    ...
    fun alertsRecent() : AlertBulkResponse {
        ...
        val localVarResponse = request<Unit, AlertBulkResponse>(
            localVariableConfig
        )
    ...
    * @return RequestConfig
    */
    fun alertsRecentRequestConfig() : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    ...
    fun alertsRetrieve(id: kotlin.Int) : Alert {
        ...
        val localVarResponse = request<Unit, Alert>(
            localVariableConfig
        )
    ...
    * @return RequestConfig
    */
    fun alertsRetrieveRequestConfig(id: kotlin.Int) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    ...
    fun alertsSeen(patchedAlertBulkRequestRequest: PatchedAlertBulkRequestRequest?) : AlertBulkResponse {
        ...
        val localVarResponse = request<PatchedAlertBulkRequestRequest, AlertBulkResponse>(
            localVariableConfig
        )
    ...
    * @return RequestConfig
    */
    fun alertsSeenRequestConfig(patchedAlertBulkRequestRequest: PatchedAlertBulkRequestRequest?) : RequestConfig<PatchedAlertBulkRequestRequest> {
        val localVariableBody = patchedAlertBulkRequestRequest
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    * @return RequestConfig
    */
    fun alertsUnreadRequestConfig() : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
