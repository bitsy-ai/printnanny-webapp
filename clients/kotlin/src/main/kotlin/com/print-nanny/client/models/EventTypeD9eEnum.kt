...
enum class EventTypeD9eEnum(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: Any?): kotlin.String? = if (data is EventTypeD9eEnum) "$data" else null

        /**
         * Returns a valid [EventTypeD9eEnum] for [data], null otherwise.
         */
        fun decode(data: Any?): EventTypeD9eEnum? = data?.let {
