...
enum class RemoteControlCommandCommandEnum(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: Any?): kotlin.String? = if (data is RemoteControlCommandCommandEnum) "$data" else null

        /**
         * Returns a valid [RemoteControlCommandCommandEnum] for [data], null otherwise.
         */
        fun decode(data: Any?): RemoteControlCommandCommandEnum? = data?.let {
