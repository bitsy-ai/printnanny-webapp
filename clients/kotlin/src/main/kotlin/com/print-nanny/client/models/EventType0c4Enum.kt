...
enum class EventType0c4Enum(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: Any?): kotlin.String? = if (data is EventType0c4Enum) "$data" else null

        /**
         * Returns a valid [EventType0c4Enum] for [data], null otherwise.
         */
        fun decode(data: Any?): EventType0c4Enum? = data?.let {
