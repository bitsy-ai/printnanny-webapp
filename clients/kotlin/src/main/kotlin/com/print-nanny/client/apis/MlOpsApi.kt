...
class MlOpsApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun deviceCalibrationUpdateOrCreate(deviceCalibrationRequest: DeviceCalibrationRequest) : DeviceCalibration {
        ...
        val localVarResponse = request<DeviceCalibrationRequest, DeviceCalibration>(
            localVariableConfig
        )
    ...
    */
    fun deviceCalibrationUpdateOrCreateRequestConfig(deviceCalibrationRequest: DeviceCalibrationRequest) : RequestConfig<DeviceCalibrationRequest> {
        val localVariableBody = deviceCalibrationRequest
    ...
    */
    ...
    fun deviceCalibrationsList(page: kotlin.Int?) : PaginatedDeviceCalibrationList {
        ...
        val localVarResponse = request<Unit, PaginatedDeviceCalibrationList>(
            localVariableConfig
        )
    ...
    * @return RequestConfig
    */
    fun deviceCalibrationsListRequestConfig(page: kotlin.Int?) : RequestConfig<Unit> {
    ...
    */
    ...
    fun deviceCalibrationsPartialUpdate(id: kotlin.Int, patchedDeviceCalibrationRequest: PatchedDeviceCalibrationRequest?) : DeviceCalibration {
        ...
        val localVarResponse = request<PatchedDeviceCalibrationRequest, DeviceCalibration>(
            localVariableConfig
        )
    ...
    * @return RequestConfig
    */
    fun deviceCalibrationsPartialUpdateRequestConfig(id: kotlin.Int, patchedDeviceCalibrationRequest: PatchedDeviceCalibrationRequest?) : RequestConfig<PatchedDeviceCalibrationRequest> {
        val localVariableBody = patchedDeviceCalibrationRequest
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    ...
    fun deviceCalibrationsRetrieve(id: kotlin.Int) : DeviceCalibration {
        ...
        val localVarResponse = request<Unit, DeviceCalibration>(
            localVariableConfig
        )
    ...
    * @return RequestConfig
    */
    fun deviceCalibrationsRetrieveRequestConfig(id: kotlin.Int) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    * @return RequestConfig
    */
    fun deviceCalibrationsUpdateRequestConfig(id: kotlin.Int, deviceCalibrationRequest: DeviceCalibrationRequest) : RequestConfig<DeviceCalibrationRequest> {
        val localVariableBody = deviceCalibrationRequest
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    ...
    fun experimentDeviceConfigsList(page: kotlin.Int?) : PaginatedExperimentDeviceConfigList {
        ...
        val localVarResponse = request<Unit, PaginatedExperimentDeviceConfigList>(
            localVariableConfig
        )
    ...
    * @return RequestConfig
    */
    fun experimentDeviceConfigsListRequestConfig(page: kotlin.Int?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (page != null) {
    ...
    */
    ...
    fun experimentDeviceConfigsRetrieve(id: kotlin.Int) : ExperimentDeviceConfig {
        ...
        val localVarResponse = request<Unit, ExperimentDeviceConfig>(
            localVariableConfig
        )
    ...
    * @return RequestConfig
    */
    fun experimentDeviceConfigsRetrieveRequestConfig(id: kotlin.Int) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    ...
    fun experimentsList(page: kotlin.Int?) : PaginatedExperimentList {
        ...
        val localVarResponse = request<Unit, PaginatedExperimentList>(
            localVariableConfig
        )
    ...
    * @return RequestConfig
    */
    fun experimentsListRequestConfig(page: kotlin.Int?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (page != null) {
    ...
    */
    ...
    fun experimentsRetrieve(id: kotlin.Int) : Experiment {
        ...
        val localVarResponse = request<Unit, Experiment>(
            localVariableConfig
        )
    ...
    * @return RequestConfig
    */
    fun experimentsRetrieveRequestConfig(id: kotlin.Int) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    ...
    fun modelArtifactsList(page: kotlin.Int?) : PaginatedModelArtifactList {
        ...
        val localVarResponse = request<Unit, PaginatedModelArtifactList>(
            localVariableConfig
        )
    ...
    * @return RequestConfig
    */
    fun modelArtifactsListRequestConfig(page: kotlin.Int?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (page != null) {
    ...
    */
    ...
    fun modelArtifactsRetrieve(id: kotlin.Int) : ModelArtifact {
        ...
        val localVarResponse = request<Unit, ModelArtifact>(
            localVariableConfig
        )
    ...
    * @return RequestConfig
    */
    fun modelArtifactsRetrieveRequestConfig(id: kotlin.Int) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
