# Generated by Django 3.1.7 on 2021-05-04 09:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('printer_models', print_nanny_webapp.utils.fields.ChoiceArrayField(base_field=models.CharField(choices=[('PRUSA', 'Prusa'), ('CREALITY', 'Creality'), ('FLASHFORGE', 'Flashforge'), ('MONOPRICE', 'Monoprice'), ('FORMLABS', 'Formlabs'), ('LULZBOT', 'LulzBot'), ('ULTIMAKER', 'Ultimaker'), ('MARKFORGED', 'Markforged'), ('PEOPOLY', 'Peopoly'), ('TOYBOX', 'Toybox'), ('MAKERBOT', 'Makerbot'), ('DREMEL', 'Dremel'), ('OTHER', 'Other')], max_length=32), help_text='Check all that apply', size=None)),
                ('num_printers', models.IntegerField()),
                ('printer_models_other', models.CharField(max_length=255)),
                ('filament_type', print_nanny_webapp.utils.fields.ChoiceArrayField(base_field=models.CharField(choices=[('PLA', 'PLA'), ('PETG', 'PETG'), ('ABS', 'ASA/ABS'), ('BVOH', 'Soluble (BVOH)'), ('WOOD', 'Wood Composite'), ('Metal', 'Metal Composite'), ('OTHER', 'Other')], max_length=32), help_text='Check all that apply', size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('site', models.CharField(choices=[('blog', 'blog.print-nanny.com'), ('help', 'help.print-nanny.com')], max_length=32)),
