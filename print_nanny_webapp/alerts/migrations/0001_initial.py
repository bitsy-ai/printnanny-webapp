    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('original_video', models.FileField(null=True, upload_to=print_nanny_webapp.alerts.models.AnnotatedVideo._upload_to)),
                ('annotated_video', models.FileField(null=True, upload_to=print_nanny_webapp.alerts.models.AnnotatedVideo._upload_to)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dataframe', models.FileField(upload_to='')),
