    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('polymorphic_ctype', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='polymorphic_alerts.alertvideomessage_set+', to='contenttypes.contenttype')),
        ...
        migrations.CreateModel(
            name='TimelapseAlert',
            fields=[
                ('alertvideomessage_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='alerts.alertvideomessage')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alert', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='alerts.alertvideomessage')),
            ],
        ),
        migrations.CreateModel(
            name='ProgressAlert',
