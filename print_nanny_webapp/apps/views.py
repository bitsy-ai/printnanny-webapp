...
# calendar
apps_calendar_calendar_view = AppsView.as_view(
    template_name="apps/calendar/calendar.html"
)
...
apps_ecommerce_orders_details_view = AppsView.as_view(
...
apps_ecommerce_products_details_view = AppsView.as_view(
...
apps_ecommerce_shopping_cart_view = AppsView.as_view(
...
apps_projects_details_view = AppsView.as_view(
    template_name="apps/projects/details.html"
)
...
# custom
apps_coming_soon_view = AppsView.as_view(template_name="apps/coming-soon.html")
