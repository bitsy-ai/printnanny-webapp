...
urlpatterns = [
    ...
    # custom
    path("coming-soon-remote-control", view=apps_coming_soon_view, name="coming-soon-remote-control"),
    path("coming-soon-print-library", view=apps_coming_soon_view, name="coming-soon-print-library"),
    path("coming-soon-webhooks", view=apps_coming_soon_view, name="coming-soon-webhooks"),
    path("coming-soon-webhooks", view=apps_coming_soon_view, name="coming-soon-webhooks"),
