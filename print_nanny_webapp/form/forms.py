...
class SampleForm(forms.Form):
    ...
    text_area = forms.CharField(
        label="Text area", required=False, widget=forms.Textarea(attrs={"rows": 5})
    )
    ...
    read_only = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={"placeholder": "Readonly value", "readonly": "readonly"}
        ),
    )
    ...
    disabled = forms.CharField(
        ...
        required=False,
        widget=forms.TextInput(
            attrs={"placeholder": "Disabled value", "disabled": "disabled"}
        ),
    )

    static = forms.CharField(
...
class SampleForm2(forms.Form):
    select = forms.ChoiceField(
        label="Select Input", required=False, choices=[(i, i) for i in range(1, 6)]
    )
    ...
    date = forms.CharField(
        label="Date", required=False, widget=forms.DateInput(attrs={"type": "date"})
    )
    month = forms.CharField(
        label="Month", required=False, widget=forms.TextInput(attrs={"type": "month"})
    )
    time = forms.CharField(
        label="Time", required=False, widget=forms.TextInput(attrs={"type": "time"})
    )
    week = forms.CharField(
        label="Week", required=False, widget=forms.TextInput(attrs={"type": "week"})
    )
...
class SampleForm3(forms.Form):
    small = forms.CharField(
        ...
        required=False,
        widget=forms.TextInput(
            attrs={"class": "form-control-sm", "placeholder": ".input-sm"}
        ),
    )
    normal = forms.CharField(
        label="Normal",
        required=False,
    ...
    large = forms.CharField(
        ...
        required=False,
        widget=forms.TextInput(
            attrs={"placeholder": "large", "class": "form-control-lg"}
        ),
    )
    grid_size = forms.CharField(
        label="Grid Size",
        required=False,
...
class SampleForm4(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            FieldWithButtons(
                "button", StrictButton("Button", css_class="btn btn-dark")
            ),
        )
...
class SampleForm7(forms.Form):
    ...
    radio1 = forms.BooleanField(
        label="Toggle this custom radio", required=False, widget=forms.RadioSelect()
    )
    radio2 = forms.BooleanField(
        label="Or toggle this custom radio", required=False, widget=forms.RadioSelect()
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Div(
                CustomCheckbox("checkbox4"),
                CustomCheckbox("checkbox5"),
                css_class="form-group",
            ),
            Div(CustomRadio("radio1"), CustomRadio("radio2"), css_class="form-group"),
            Div(
                CustomSwitch("switch1"), CustomSwitch("switch2"), css_class="form-group"
            ),
        )
