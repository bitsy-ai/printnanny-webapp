    ...
    def receive(self, text_data):
        ...
        if data.get('msg') == "ping":
            ...
            files = PredictEventFile.objects.create(
                annotated_image=SimpleUploadedFile('annotated_image.jpg', base64.b64decode(data['annotated_image'])),
                hash=imghash,
                original_image=SimpleUploadedFile('original_image.jpg', base64.b64decode(data['original_image'])),
            )
            ...
            if job.user_id ==  self.user.id:
                ...
                logging.warning(f'user {self.user} tried to publish event to job {job.id}')