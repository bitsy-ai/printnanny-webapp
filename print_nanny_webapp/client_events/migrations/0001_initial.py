    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('files', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='client_events.predicteventfile')),
                ('predict_session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='client_events.predictsession')),
