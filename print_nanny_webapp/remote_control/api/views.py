...
from .serializers import (
    ...
    RemoteControlResponseSnapshotSerializer
)
...
class RemoteControlSnapshotViewSet(
    ...
    @extend_schema(
        ...
        responses={
            ...
            201: RemoteControlSnapshotResponseSerializer,
        },
    )
    def create(self, request):
        ...
        if serializer.is_valid():
            ...
            response_serializer = RemoteControlSnapshotResponseSerializer(instance=instance)
            return Response(response_serializer.data, status=status.HTTP_201_CREATED)
