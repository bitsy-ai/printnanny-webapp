    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpu_flags', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255), null=True, size=None)),
                ...
                ('monitoring_mode', models.CharField(choices=[('active_learning', 'Active Learning'), ('lite', 'Lite')], default='lite', max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('volume_custom_box', django.contrib.postgres.fields.jsonb.JSONField(default={})),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('command', models.CharField(choices=[('monitoring_stop', 'Stop Print Nanny Monitoring'), ('monitoring_start', 'Start Print Nanny Monitoring'), ('print_start', 'Start Print'), ('print_stop', 'Stop Print'), ('print_pause', 'Pause Print'), ('print_resume', 'Resume Print'), ('move_nozzle', 'Move Nozzle')], max_length=255)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='remote_control.octoprintdevice'),
        ),
        migrations.AddField(
            model_name='gcodefile',
            name='user',
