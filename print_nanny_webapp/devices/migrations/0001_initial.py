    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_dt', models.DateTimeField(auto_now=True, db_index=True)),
                ('name', models.CharField(max_length=255)),
                ('controller', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='printer_profiles', to='devices.printercontroller')),
                ('device', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='devices.device')),
                ('polymorphic_ctype', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='polymorphic_devices.printerprofile_set+', to='contenttypes.contenttype')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('printercontroller_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='devices.printercontroller')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('printerprofile_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='devices.printerprofile')),
                ...
                ('octoprint_controller', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='devices.octoprintcontroller')),
            ],
            options={
                'abstract': False,
                'base_manager_name': 'objects',
