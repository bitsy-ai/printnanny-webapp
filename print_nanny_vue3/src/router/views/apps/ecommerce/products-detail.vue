                  ...
                  <tr>
                    ...
                    <td>
                      <div class="progress-w-percent mb-0">
                        ...
                        <b-progress height="5px" :value="56" variant="success"></b-progress>
                      </div>
                    </td>
                    <td>$1,89,547</td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <div class="progress-w-percent mb-0">
                        ...
                        <b-progress height="5px" :value="16" variant="danger"></b-progress>
                      </div>
                    </td>
                    <td>$87,245</td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <div class="progress-w-percent mb-0">
                        ...
                        <b-progress height="5px" :value="72" variant="success"></b-progress>
                      </div>
                    </td>
                    <td>$5,87,478</td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <div class="progress-w-percent mb-0">
                        ...
                        <b-progress height="5px" :value="89" variant="success"></b-progress>
                      </div>
                    </td>
                    <td>$55,781</td>
                  </tr>
