...
##
# The following config is a for a non-production sandbox, deployed to GKE as a monolithic application
##
...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=[".sandbox.print-nanny.com"])
...
BASE_URL = env("PRINTNANNY_BASE_URL")
STATIC_URL = env("PRINTNANNY_STATIC_URL")
